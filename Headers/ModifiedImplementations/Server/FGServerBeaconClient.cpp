...
FLargeDataTransfer::FLargeDataTransfer(const TArray<uint8>& Data, FOnLargeTransferCompleted OnTransferCompleted){ }
FLargeDataTransfer::FLargeDataTransfer(const FGuid& ID, int32 Size){ }
