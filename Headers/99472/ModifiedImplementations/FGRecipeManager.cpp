...
void AFGRecipeManager::GetAvailableRecipesForProducerAndPhase( TSubclassOf< UObject > forProducer, EGamePhase gamePhase, TArray< TSubclassOf< UFGRecipe > >& out_recipes){ }
