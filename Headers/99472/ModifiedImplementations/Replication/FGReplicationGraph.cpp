...
void UFGReplicationGraph::OnCharacterPersistentEquipmentSpawned(  AFGCharacterPlayer* pawn,  AFGEquipment* equipment){ }
void UFGReplicationGraph::OnCharacterPlayerEquip(  AFGCharacterPlayer* pawn,  AFGEquipment* equipment,  AFGEquipmentAttachment* attachment){ }
void UFGReplicationGraph::OnCharacterPlayerUnequip(  AFGCharacterPlayer* pawn,  AFGEquipment* equipment,  AFGEquipmentAttachment* attachment){ }
