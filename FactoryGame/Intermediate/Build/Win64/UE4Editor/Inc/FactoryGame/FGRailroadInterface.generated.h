...
#define FactoryGame_Source_FactoryGame_Public_FGRailroadInterface_h_15_RPC_WRAPPERS \
 ...
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(int32*)Z_Param__Result=P_THIS->GetTrackGraphID_Implementation(); \
		P_NATIVE_END; \
	} \
 \
...
#define FactoryGame_Source_FactoryGame_Public_FGRailroadInterface_h_15_EVENT_PARMS \
 ...
 \
		...
		FGRailroadInterface_eventGetTrackGraphID_Parms() \
			: ReturnValue(0) \
		{ \
		} \
	}; \
...
public: \
	...
	static int32 Execute_GetTrackGraphID(const UObject* O); \
...
template<> FACTORYGAME_API UClass* StaticClass<class UFGRailroadInterface>();
