...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UFGGameplayTask_Base_Statics::NewProp_mCachedPawn = { "mCachedPawn", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFGGameplayTask_Base, mCachedPawn), Z_Construct_UClass_AFGEnemy_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UFGGameplayTask_Base_Statics::NewProp_mCachedPawn_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFGGameplayTask_Base_Statics::NewProp_mCachedPawn_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UFGGameplayTask_Base_Statics::ClassParams = {
		...
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_UFGGameplayTask_Base_Statics::PropPointers,
		nullptr,
		ARRAY_COUNT(DependentSingletons),
		0,
		ARRAY_COUNT(Z_Construct_UClass_UFGGameplayTask_Base_Statics::PropPointers),
		0,
		0x001000A4u,
	...
	IMPLEMENT_CLASS(UFGGameplayTask_Base, 3307314492);
	template<> FACTORYGAME_API UClass* StaticClass<UFGGameplayTask_Base>()
	{
		return UFGGameplayTask_Base::StaticClass();
	}
