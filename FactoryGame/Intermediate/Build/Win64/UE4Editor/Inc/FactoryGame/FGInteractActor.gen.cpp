...
// End Cross Module References
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AFGInteractActor_OnInteract_Statics::NewProp_byCharacter = { "byCharacter", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGInteractActor_eventOnInteract_Parms, byCharacter), Z_Construct_UClass_AFGCharacterPlayer_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFGInteractActor_OnInteract_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFGInteractActor, nullptr, "OnInteract", sizeof(FGInteractActor_eventOnInteract_Parms), Z_Construct_UFunction_AFGInteractActor_OnInteract_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AFGInteractActor_OnInteract_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFGInteractActor_OnInteract_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AFGInteractActor_OnInteract_Statics::Function_MetaDataParams)) };
	...
	IMPLEMENT_CLASS(AFGInteractActor, 113670091);
