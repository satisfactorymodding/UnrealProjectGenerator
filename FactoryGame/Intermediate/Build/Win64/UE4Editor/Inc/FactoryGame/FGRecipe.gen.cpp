...
// Cross Module References
	...
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGRecipe_HasAnyProducers();
...
// End Cross Module References
	void UFGRecipe::StaticRegisterNativesUFGRecipe()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "HasAnyProducers", &UFGRecipe::execHasAnyProducers },
	...
	struct Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics
	{
		struct FGRecipe_eventHasAnyProducers_Parms
		{
			TSubclassOf<UFGRecipe>  inClass;
			bool ReturnValue;
		};
	...
	void Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((FGRecipe_eventHasAnyProducers_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGRecipe_eventHasAnyProducers_Parms), &Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::NewProp_inClass = { "inClass", nullptr, (EPropertyFlags)0x0014000000000080, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGRecipe_eventHasAnyProducers_Parms, inClass), Z_Construct_UClass_UFGRecipe_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::NewProp_ReturnValue,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::NewProp_inClass,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::Function_MetaDataParams[] = {
		{ "Category", "FactoryGame|Recipe" },
		{ "ModuleRelativePath", "Public/FGRecipe.h" },
		{ "ToolTip", "True if this recipe can be produced in the game." },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGRecipe, nullptr, "HasAnyProducers", sizeof(FGRecipe_eventHasAnyProducers_Parms), Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFGRecipe_HasAnyProducers()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGRecipe_HasAnyProducers_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFGRecipe_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFGRecipe_GetDescriptorForRecipe, "GetDescriptorForRecipe" }, // 609779944
		...
		{ &Z_Construct_UFunction_UFGRecipe_HasAnyProducers, "HasAnyProducers" }, // 3744318654
	...
	IMPLEMENT_CLASS(UFGRecipe, 3471906766);
