...
// End Cross Module References
	...
	UEnum* Z_Construct_UEnum_FactoryGame_ESessionVisibility()
	{
		...
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ESessionVisibility"), 0, Get_Z_Construct_UEnum_FactoryGame_ESessionVisibility_CRC(), false);
#else
...
class UScriptStruct* FFGOnlineSessionSettings::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FACTORYGAME_API uint32 Get_Z_Construct_UScriptStruct_FFGOnlineSessionSettings_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FFGOnlineSessionSettings, Z_Construct_UPackage__Script_FactoryGame(), TEXT("FGOnlineSessionSettings"), sizeof(FFGOnlineSessionSettings), Get_Z_Construct_UScriptStruct_FFGOnlineSessionSettings_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_FactoryGame_StaticRegisterNativesFFGOnlineSessionSettings
{
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FFGOnlineSessionSettings_Statics::NewProp_NATType = { UE4CodeGen_Private::EPropertyClass::Enum, "NATType", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000014, 1, nullptr, STRUCT_OFFSET(FFGOnlineSessionSettings, NATType), Z_Construct_UEnum_FactoryGame_ECachedNATType, METADATA_PARAMS(Z_Construct_UScriptStruct_FFGOnlineSessionSettings_Statics::NewProp_NATType_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FFGOnlineSessionSettings_Statics::NewProp_NATType_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FFGOnlineSessionSettings_Statics::NewProp_NATType_Underlying = { UE4CodeGen_Private::EPropertyClass::Byte, "UnderlyingType", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FFGOnlineSessionSettings_Statics::NewProp_PlayDuration = { UE4CodeGen_Private::EPropertyClass::Int, "PlayDuration", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000014, 1, nullptr, STRUCT_OFFSET(FFGOnlineSessionSettings, PlayDuration), METADATA_PARAMS(Z_Construct_UScriptStruct_FFGOnlineSessionSettings_Statics::NewProp_PlayDuration_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FFGOnlineSessionSettings_Statics::NewProp_PlayDuration_MetaData)) };
#if WITH_METADATA
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FFGOnlineSessionSettings_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_FactoryGame();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("FGOnlineSessionSettings"), sizeof(FFGOnlineSessionSettings), Get_Z_Construct_UScriptStruct_FFGOnlineSessionSettings_CRC(), false);
#else
