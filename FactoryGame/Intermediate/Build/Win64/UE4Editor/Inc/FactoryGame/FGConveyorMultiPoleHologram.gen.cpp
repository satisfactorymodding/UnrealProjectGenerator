...
void EmptyLinkFunctionForGeneratedCodeFGConveyorMultiPoleHologram() {}
// Cross Module References
	FACTORYGAME_API UClass* Z_Construct_UClass_AFGConveyorMultiPoleHologram_NoRegister();
	FACTORYGAME_API UClass* Z_Construct_UClass_AFGConveyorMultiPoleHologram();
	FACTORYGAME_API UClass* Z_Construct_UClass_AFGBuildableHologram();
	UPackage* Z_Construct_UPackage__Script_FactoryGame();
// End Cross Module References
	void AFGConveyorMultiPoleHologram::StaticRegisterNativesAFGConveyorMultiPoleHologram()
	{
	}
	UClass* Z_Construct_UClass_AFGConveyorMultiPoleHologram_NoRegister()
	{
		return AFGConveyorMultiPoleHologram::StaticClass();
	}
	struct Z_Construct_UClass_AFGConveyorMultiPoleHologram_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_AFGConveyorMultiPoleHologram_Statics::DependentSingletons[])() = {
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_AFGConveyorMultiPoleHologram_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<AFGConveyorMultiPoleHologram>::IsAbstract,
	};
	...
	UClass* Z_Construct_UClass_AFGConveyorMultiPoleHologram()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AFGConveyorMultiPoleHologram_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AFGConveyorMultiPoleHologram, 3225145754);
