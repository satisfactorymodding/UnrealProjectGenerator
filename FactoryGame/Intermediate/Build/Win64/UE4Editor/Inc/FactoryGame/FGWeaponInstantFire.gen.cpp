...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFGWeaponInstantFire_Server_NotifyHit_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFGWeaponInstantFire, "Server_NotifyHit", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x80280CC0, sizeof(FGWeaponInstantFire_eventServer_NotifyHit_Parms), Z_Construct_UFunction_AFGWeaponInstantFire_Server_NotifyHit_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AFGWeaponInstantFire_Server_NotifyHit_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFGWeaponInstantFire_Server_NotifyHit_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AFGWeaponInstantFire_Server_NotifyHit_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFGWeaponInstantFire_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFGWeaponInstantFire_Server_NotifyHit, "Server_NotifyHit" }, // 3787372962
		{ &Z_Construct_UFunction_AFGWeaponInstantFire_Server_NotifyMiss, "Server_NotifyMiss" }, // 2626145663
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFGWeaponInstantFire_Statics::NewProp_mHitParticleEffect = { UE4CodeGen_Private::EPropertyClass::Object, "mHitParticleEffect", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000010001, 1, nullptr, STRUCT_OFFSET(AFGWeaponInstantFire, mHitParticleEffect), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFGWeaponInstantFire_Statics::NewProp_mHitParticleEffect_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGWeaponInstantFire_Statics::NewProp_mHitParticleEffect_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFGWeaponInstantFire_Statics::NewProp_mWeaponTraceLength = { UE4CodeGen_Private::EPropertyClass::Float, "mWeaponTraceLength", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000010001, 1, nullptr, STRUCT_OFFSET(AFGWeaponInstantFire, mWeaponTraceLength), METADATA_PARAMS(Z_Construct_UClass_AFGWeaponInstantFire_Statics::NewProp_mWeaponTraceLength_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGWeaponInstantFire_Statics::NewProp_mWeaponTraceLength_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFGWeaponInstantFire_Statics::NewProp_mInstantHitDamage = { UE4CodeGen_Private::EPropertyClass::Float, "mInstantHitDamage", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000010001, 1, nullptr, STRUCT_OFFSET(AFGWeaponInstantFire, mInstantHitDamage), METADATA_PARAMS(Z_Construct_UClass_AFGWeaponInstantFire_Statics::NewProp_mInstantHitDamage_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGWeaponInstantFire_Statics::NewProp_mInstantHitDamage_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AFGWeaponInstantFire_Statics::ClassParams = {
		...
		Z_Construct_UClass_AFGWeaponInstantFire_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AFGWeaponInstantFire_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(AFGWeaponInstantFire, 808609692);
