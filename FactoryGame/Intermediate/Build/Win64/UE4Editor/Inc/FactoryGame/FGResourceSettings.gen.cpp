...
// Cross Module References
	...
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum();
...
static struct FScriptStruct_FactoryGame_StaticRegisterNativesFItemSettings
{
	...
	void UFGResourceSettings::StaticRegisterNativesUFGResourceSettings()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetStackSizeFromEnum", &UFGResourceSettings::execGetStackSizeFromEnum },
		};
	...
	struct Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics
	{
		struct FGResourceSettings_eventGetStackSizeFromEnum_Parms
		{
			EStackSize stackSize;
			int32 ReturnValue;
		};
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_ReturnValue;
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_stackSize;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_stackSize_Underlying;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGResourceSettings_eventGetStackSizeFromEnum_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::NewProp_stackSize = { "stackSize", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGResourceSettings_eventGetStackSizeFromEnum_Parms, stackSize), Z_Construct_UEnum_FactoryGame_EStackSize, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::NewProp_stackSize_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::NewProp_ReturnValue,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::NewProp_stackSize,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::NewProp_stackSize_Underlying,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::Function_MetaDataParams[] = {
		{ "Category", "Resources" },
		{ "ModuleRelativePath", "Public/FGResourceSettings.h" },
		{ "ToolTip", "Gets the size of a Given Stack Size enum from the stack size TMap" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGResourceSettings, nullptr, "GetStackSizeFromEnum", sizeof(FGResourceSettings_eventGetStackSizeFromEnum_Parms), Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mWaterResourceDescriptor_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mWaterResourceDescriptor;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFGResourceSettings_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UFGResourceSettings_GetStackSizeFromEnum, "GetStackSizeFromEnum" }, // 2234510335
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFGResourceSettings_Statics::NewProp_mWaterResourceDescriptor_MetaData[] = {
		{ "Category", "Resources" },
		{ "ModuleRelativePath", "Public/FGResourceSettings.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UFGResourceSettings_Statics::NewProp_mWaterResourceDescriptor = { "mWaterResourceDescriptor", nullptr, (EPropertyFlags)0x0014000000010001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFGResourceSettings, mWaterResourceDescriptor), Z_Construct_UClass_UFGResourceDescriptor_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UFGResourceSettings_Statics::NewProp_mWaterResourceDescriptor_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFGResourceSettings_Statics::NewProp_mWaterResourceDescriptor_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UFGResourceSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UFGResourceSettings_Statics::NewProp_mWaterResourceDescriptor,
	...
	IMPLEMENT_CLASS(UFGResourceSettings, 677515899);
