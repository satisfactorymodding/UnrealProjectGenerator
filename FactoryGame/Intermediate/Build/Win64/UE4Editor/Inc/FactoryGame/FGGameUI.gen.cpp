...
// Cross Module References
	FACTORYGAME_API UFunction* Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature();
...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::NewProp_InMouseEvent_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::NewProp_InMouseEvent = { "InMouseEvent", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_FactoryGame_eventOnMouseButtonDown_Parms, InMouseEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::NewProp_InMouseEvent_MetaData, ARRAY_COUNT(Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::NewProp_InMouseEvent_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::NewProp_InGeometry_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::NewProp_InGeometry = { "InGeometry", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_FactoryGame_eventOnMouseButtonDown_Parms, InGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::NewProp_InGeometry_MetaData, ARRAY_COUNT(Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::NewProp_InGeometry_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::NewProp_InMouseEvent,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::NewProp_InGeometry,
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_FactoryGame, nullptr, "OnMouseButtonDown__DelegateSignature", sizeof(_Script_FactoryGame_eventOnMouseButtonDown_Parms), Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature_Statics::FuncParams);
		}
	...
	static FName NAME_UFGGameUI_PopWidget = FName(TEXT("PopWidget"));
	bool UFGGameUI::PopWidget(UFGInteractWidget* WidgetToRemove)
	{
		FGGameUI_eventPopWidget_Parms Parms;
		Parms.WidgetToRemove=WidgetToRemove;
		ProcessEvent(FindFunctionChecked(NAME_UFGGameUI_PopWidget),&Parms);
		return !!Parms.ReturnValue;
	}
	static FName NAME_UFGGameUI_PushWidget = FName(TEXT("PushWidget"));
	void UFGGameUI::PushWidget(UFGInteractWidget* Widget)
	{
		FGGameUI_eventPushWidget_Parms Parms;
		Parms.Widget=Widget;
		ProcessEvent(FindFunctionChecked(NAME_UFGGameUI_PushWidget),&Parms);
	}
	...
	static FName NAME_UFGGameUI_ShowDirectionalSubtitle = FName(TEXT("ShowDirectionalSubtitle"));
	void UFGGameUI::ShowDirectionalSubtitle(FText const& Subtitle, AActor* Instigator, float Duration, bool bUseDuration)
	{
		FGGameUI_eventShowDirectionalSubtitle_Parms Parms;
	...
	{
		FGGameUI_eventStopSubtitle_Parms Parms;
		Parms.Instigator=Instigator;
		ProcessEvent(FindFunctionChecked(NAME_UFGGameUI_StopSubtitle),&Parms);
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGGameUI_AddCheatWidget_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventAddCheatWidget_Parms, ReturnValue), Z_Construct_UClass_UFGPopupWidget_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_AddCheatWidget_Statics::NewProp_ReturnValue_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_AddCheatWidget_Statics::NewProp_ReturnValue_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UFGGameUI_AddCheatWidget_Statics::NewProp_popupData = { "popupData", nullptr, (EPropertyFlags)0x0010008000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventAddCheatWidget_Parms, popupData), Z_Construct_UScriptStruct_FPopupData, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_AddInteractWidget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "AddInteractWidget", sizeof(FGGameUI_eventAddInteractWidget_Parms), Z_Construct_UFunction_UFGGameUI_AddInteractWidget_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_AddInteractWidget_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_AddInteractWidget_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_AddInteractWidget_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UFGGameUI_AddIntroTutorialInfo_Statics::NewProp_tutorialHintData = { "tutorialHintData", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventAddIntroTutorialInfo_Parms, tutorialHintData), Z_Construct_UScriptStruct_FTutorialHintData, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_AddIntroTutorialInfo_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "AddIntroTutorialInfo", sizeof(FGGameUI_eventAddIntroTutorialInfo_Parms), Z_Construct_UFunction_UFGGameUI_AddIntroTutorialInfo_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_AddIntroTutorialInfo_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_AddIntroTutorialInfo_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_AddIntroTutorialInfo_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGGameUI_AddPawnHUD_Statics::NewProp_newContent = { "newContent", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventAddPawnHUD_Parms, newContent), Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_AddPawnHUD_Statics::NewProp_newContent_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_AddPawnHUD_Statics::NewProp_newContent_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_AddPawnHUD_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "AddPawnHUD", sizeof(FGGameUI_eventAddPawnHUD_Parms), Z_Construct_UFunction_UFGGameUI_AddPawnHUD_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_AddPawnHUD_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_AddPawnHUD_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_AddPawnHUD_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UFGGameUI_AddPendingMessage_Statics::NewProp_newMessage = { "newMessage", nullptr, (EPropertyFlags)0x0014000000000080, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventAddPendingMessage_Parms, newMessage), Z_Construct_UClass_UFGMessageBase_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UFGGameUI_CanReceiveMessage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGGameUI_eventCanReceiveMessage_Parms), &Z_Construct_UFunction_UFGGameUI_CanReceiveMessage_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UFGGameUI_CanReceiveMessage_Statics::NewProp_inMessage = { "inMessage", nullptr, (EPropertyFlags)0x0014000000000080, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventCanReceiveMessage_Parms, inMessage), Z_Construct_UClass_UFGMessageBase_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_CanReceiveMessage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "CanReceiveMessage", sizeof(FGGameUI_eventCanReceiveMessage_Parms), Z_Construct_UFunction_UFGGameUI_CanReceiveMessage_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_CanReceiveMessage_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_CanReceiveMessage_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_CanReceiveMessage_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGGameUI_GetCurrentAudioMessage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventGetCurrentAudioMessage_Parms, ReturnValue), Z_Construct_UClass_UFGAudioMessage_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_GetCurrentAudioMessage_Statics::NewProp_ReturnValue_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_GetCurrentAudioMessage_Statics::NewProp_ReturnValue_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_GetCurrentAudioMessage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "GetCurrentAudioMessage", sizeof(FGGameUI_eventGetCurrentAudioMessage_Parms), Z_Construct_UFunction_UFGGameUI_GetCurrentAudioMessage_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_GetCurrentAudioMessage_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_GetCurrentAudioMessage_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_GetCurrentAudioMessage_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_GetInteractWidgetStack_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "GetInteractWidgetStack", sizeof(FGGameUI_eventGetInteractWidgetStack_Parms), Z_Construct_UFunction_UFGGameUI_GetInteractWidgetStack_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_GetInteractWidgetStack_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_GetInteractWidgetStack_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_GetInteractWidgetStack_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UFGGameUI_GetPendingMessages_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0014000000000580, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventGetPendingMessages_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UFGGameUI_GetPendingMessages_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0004000000000000, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UFGMessageBase_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_GetPendingMessages_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "GetPendingMessages", sizeof(FGGameUI_eventGetPendingMessages_Parms), Z_Construct_UFunction_UFGGameUI_GetPendingMessages_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_GetPendingMessages_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_GetPendingMessages_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_GetPendingMessages_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UFGGameUI_GetShowInventory_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGGameUI_eventGetShowInventory_Parms), &Z_Construct_UFunction_UFGGameUI_GetShowInventory_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_GetShowInventory_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "GetShowInventory", sizeof(FGGameUI_eventGetShowInventory_Parms), Z_Construct_UFunction_UFGGameUI_GetShowInventory_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_GetShowInventory_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_GetShowInventory_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_GetShowInventory_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UFGGameUI_GetWindowWantsInventoryAddon_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGGameUI_eventGetWindowWantsInventoryAddon_Parms), &Z_Construct_UFunction_UFGGameUI_GetWindowWantsInventoryAddon_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UFGGameUI_OnRadiationIntensityUpdated_Statics::NewProp_radiationImmunity = { "radiationImmunity", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventOnRadiationIntensityUpdated_Parms, radiationImmunity), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UFGGameUI_OnRadiationIntensityUpdated_Statics::NewProp_radiationIntensity = { "radiationIntensity", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventOnRadiationIntensityUpdated_Parms, radiationIntensity), METADATA_PARAMS(nullptr, 0) };
	...
	struct Z_Construct_UFunction_UFGGameUI_PopWidget_Statics
	{
		static void NewProp_ReturnValue_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
#if WITH_METADATA
	...
	void Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((FGGameUI_eventPopWidget_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGGameUI_eventPopWidget_Parms), &Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::NewProp_WidgetToRemove_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::NewProp_WidgetToRemove = { "WidgetToRemove", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventPopWidget_Parms, WidgetToRemove), Z_Construct_UClass_UFGInteractWidget_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::NewProp_WidgetToRemove_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::NewProp_WidgetToRemove_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::NewProp_ReturnValue,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::NewProp_WidgetToRemove,
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "PopWidget", sizeof(FGGameUI_eventPopWidget_Parms), Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFGGameUI_PopWidget()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGGameUI_PopWidget_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGGameUI_PushWidget_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::NewProp_Widget_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::NewProp_Widget = { "Widget", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventPushWidget_Parms, Widget), Z_Construct_UClass_UFGInteractWidget_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::NewProp_Widget_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::NewProp_Widget_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::NewProp_Widget,
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "PushWidget", sizeof(FGGameUI_eventPushWidget_Parms), Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFGGameUI_PushWidget()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGGameUI_PushWidget_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UFGGameUI_ReceivedMessage_Statics::NewProp_inMessage = { "inMessage", nullptr, (EPropertyFlags)0x0014000000000080, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventReceivedMessage_Parms, inMessage), Z_Construct_UClass_UFGMessageBase_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_ReceivedMessage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "ReceivedMessage", sizeof(FGGameUI_eventReceivedMessage_Parms), Z_Construct_UFunction_UFGGameUI_ReceivedMessage_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_ReceivedMessage_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_ReceivedMessage_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_ReceivedMessage_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_RemoveInteractWidget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "RemoveInteractWidget", sizeof(FGGameUI_eventRemoveInteractWidget_Parms), Z_Construct_UFunction_UFGGameUI_RemoveInteractWidget_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_RemoveInteractWidget_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_RemoveInteractWidget_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_RemoveInteractWidget_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGGameUI_SetCurrentAudioMessage_Statics::NewProp_newMessage = { "newMessage", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventSetCurrentAudioMessage_Parms, newMessage), Z_Construct_UClass_UFGAudioMessage_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_SetCurrentAudioMessage_Statics::NewProp_newMessage_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_SetCurrentAudioMessage_Statics::NewProp_newMessage_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_SetCurrentAudioMessage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "SetCurrentAudioMessage", sizeof(FGGameUI_eventSetCurrentAudioMessage_Parms), Z_Construct_UFunction_UFGGameUI_SetCurrentAudioMessage_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_SetCurrentAudioMessage_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_SetCurrentAudioMessage_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_SetCurrentAudioMessage_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UFGGameUI_SetShowInventory_Statics::NewProp_doShow = { "doShow", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGGameUI_eventSetShowInventory_Parms), &Z_Construct_UFunction_UFGGameUI_SetShowInventory_Statics::NewProp_doShow_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UFGGameUI_SetWindowWantsInventoryAddon_Statics::NewProp_doWantAddon = { "doWantAddon", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGGameUI_eventSetWindowWantsInventoryAddon_Parms), &Z_Construct_UFunction_UFGGameUI_SetWindowWantsInventoryAddon_Statics::NewProp_doWantAddon_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_SetWindowWantsInventoryAddon_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "SetWindowWantsInventoryAddon", sizeof(FGGameUI_eventSetWindowWantsInventoryAddon_Parms), Z_Construct_UFunction_UFGGameUI_SetWindowWantsInventoryAddon_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_SetWindowWantsInventoryAddon_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_SetWindowWantsInventoryAddon_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_SetWindowWantsInventoryAddon_Statics::Function_MetaDataParams)) };
	...
	struct Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics
	{
	...
	void Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_bUseDuration_SetBit(void* Obj)
	{
		((FGGameUI_eventShowDirectionalSubtitle_Parms*)Obj)->bUseDuration = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_bUseDuration = { "bUseDuration", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGGameUI_eventShowDirectionalSubtitle_Parms), &Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_bUseDuration_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_Duration = { "Duration", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventShowDirectionalSubtitle_Parms, Duration), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_Instigator = { "Instigator", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventShowDirectionalSubtitle_Parms, Instigator), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_Subtitle_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_Subtitle = { "Subtitle", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventShowDirectionalSubtitle_Parms, Subtitle), METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_Subtitle_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_Subtitle_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_bUseDuration,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_Duration,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_Instigator,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::NewProp_Subtitle,
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "ShowDirectionalSubtitle", sizeof(FGGameUI_eventShowDirectionalSubtitle_Parms), Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C420800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGGameUI_ShowDirectionalSubtitle_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGGameUI_StopSubtitle_Statics::NewProp_Instigator = { "Instigator", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGGameUI_eventStopSubtitle_Parms, Instigator), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFGGameUI_StopSubtitle_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGGameUI_StopSubtitle_Statics::NewProp_Instigator,
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGGameUI_StopSubtitle_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGGameUI, nullptr, "StopSubtitle", sizeof(FGGameUI_eventStopSubtitle_Parms), Z_Construct_UFunction_UFGGameUI_StopSubtitle_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_StopSubtitle_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGGameUI_StopSubtitle_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGGameUI_StopSubtitle_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFGGameUI_StopSubtitle()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGGameUI_StopSubtitle_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mOnMouseButtonDown_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_mOnMouseButtonDown;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFGGameUI_Statics::NewProp_mMinTimeBetweenAudioMessage = { "mMinTimeBetweenAudioMessage", nullptr, (EPropertyFlags)0x0040000000010001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFGGameUI, mMinTimeBetweenAudioMessage), METADATA_PARAMS(Z_Construct_UClass_UFGGameUI_Statics::NewProp_mMinTimeBetweenAudioMessage_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFGGameUI_Statics::NewProp_mMinTimeBetweenAudioMessage_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UFGGameUI_Statics::NewProp_mInteractWidgetStack = { "mInteractWidgetStack", nullptr, (EPropertyFlags)0x0040008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFGGameUI, mInteractWidgetStack), METADATA_PARAMS(Z_Construct_UClass_UFGGameUI_Statics::NewProp_mInteractWidgetStack_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFGGameUI_Statics::NewProp_mInteractWidgetStack_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UFGGameUI_Statics::NewProp_mInteractWidgetStack_Inner = { "mInteractWidgetStack", nullptr, (EPropertyFlags)0x0000000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UFGInteractWidget_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UFGGameUI_Statics::NewProp_mOnMouseButtonDown = { "mOnMouseButtonDown", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::MulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFGGameUI, mOnMouseButtonDown), Z_Construct_UDelegateFunction_FactoryGame_OnMouseButtonDown__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UFGGameUI_Statics::NewProp_mOnMouseButtonDown_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFGGameUI_Statics::NewProp_mOnMouseButtonDown_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UFGGameUI_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UFGGameUI_Statics::NewProp_mOnMouseButtonDown,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UFGGameUI_Statics::ClassParams = {
		...
		DependentSingletons,
		FuncInfo,
		Z_Construct_UClass_UFGGameUI_Statics::PropPointers,
		nullptr,
		ARRAY_COUNT(DependentSingletons),
		ARRAY_COUNT(FuncInfo),
		ARRAY_COUNT(Z_Construct_UClass_UFGGameUI_Statics::PropPointers),
		0,
		0x00B010A0u,
