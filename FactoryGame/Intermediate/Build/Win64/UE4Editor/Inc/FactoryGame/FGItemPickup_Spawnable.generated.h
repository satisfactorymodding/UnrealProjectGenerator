...
template<> FACTORYGAME_API UClass* StaticClass<class AFGItemPickup_Spawnable>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FactoryGame_Source_FactoryGame_FGItemPickup_Spawnable_h
