...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFGRailroadVehicleHologram_Statics::NewProp_mLength = { UE4CodeGen_Private::EPropertyClass::Float, "mLength", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(AFGRailroadVehicleHologram, mLength), METADATA_PARAMS(Z_Construct_UClass_AFGRailroadVehicleHologram_Statics::NewProp_mLength_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGRailroadVehicleHologram_Statics::NewProp_mLength_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AFGRailroadVehicleHologram_Statics::ClassParams = {
		...
		0x009000A0u,
		nullptr, 0,
		Z_Construct_UClass_AFGRailroadVehicleHologram_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AFGRailroadVehicleHologram_Statics::PropPointers),
		nullptr,
