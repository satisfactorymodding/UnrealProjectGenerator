...
// End Cross Module References
	...
	UEnum* Z_Construct_UEnum_FactoryGame_EDockStationType()
	{
		...
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EDockStationType"), 0, Get_Z_Construct_UEnum_FactoryGame_EDockStationType_Hash(), false);
#else
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UFGDockableInterface_CanDock_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGDockableInterface_eventCanDock_Parms), &Z_Construct_UFunction_UFGDockableInterface_CanDock_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UFGDockableInterface_CanDock_Statics::NewProp_atStation = { "atStation", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGDockableInterface_eventCanDock_Parms, atStation), Z_Construct_UEnum_FactoryGame_EDockStationType, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UFGDockableInterface_CanDock_Statics::NewProp_atStation_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGDockableInterface_GetDockFuelInventory_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGDockableInterface_eventGetDockFuelInventory_Parms, ReturnValue), Z_Construct_UClass_UFGInventoryComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UFGDockableInterface_GetDockFuelInventory_Statics::NewProp_ReturnValue_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UFGDockableInterface_GetDockFuelInventory_Statics::NewProp_ReturnValue_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGDockableInterface_GetDockFuelInventory_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGDockableInterface, nullptr, "GetDockFuelInventory", sizeof(FGDockableInterface_eventGetDockFuelInventory_Parms), Z_Construct_UFunction_UFGDockableInterface_GetDockFuelInventory_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGDockableInterface_GetDockFuelInventory_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x5C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGDockableInterface_GetDockFuelInventory_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGDockableInterface_GetDockFuelInventory_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGDockableInterface_GetDockInventory_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGDockableInterface_eventGetDockInventory_Parms, ReturnValue), Z_Construct_UClass_UFGInventoryComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UFGDockableInterface_GetDockInventory_Statics::NewProp_ReturnValue_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UFGDockableInterface_GetDockInventory_Statics::NewProp_ReturnValue_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGDockableInterface_OnTransferComplete_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGDockableInterface, nullptr, "OnTransferComplete", 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGDockableInterface_OnTransferComplete_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGDockableInterface_OnTransferComplete_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UFGDockableInterface_WasDocked_Statics::NewProp_atStation = { "atStation", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGDockableInterface_eventWasDocked_Parms, atStation), Z_Construct_UClass_AFGBuildableDockingStation_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGDockableInterface_WasDocked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGDockableInterface, nullptr, "WasDocked", sizeof(FGDockableInterface_eventWasDocked_Parms), Z_Construct_UFunction_UFGDockableInterface_WasDocked_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGDockableInterface_WasDocked_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGDockableInterface_WasDocked_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGDockableInterface_WasDocked_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGDockableInterface_WasUndocked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGDockableInterface, nullptr, "WasUndocked", 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGDockableInterface_WasUndocked_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGDockableInterface_WasUndocked_Statics::Function_MetaDataParams)) };
