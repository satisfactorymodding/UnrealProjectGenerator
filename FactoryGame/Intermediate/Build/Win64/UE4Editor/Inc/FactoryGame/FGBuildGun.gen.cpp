...
// Cross Module References
	...
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_BeginBuildGunDelay();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_BeginState();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_BuildGunDelayIsComplete();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_BuildSamplePressed();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_BuildSampleRelease();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_ChangeGuideLinesSnapMode();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_ChangeNoSnapMode();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_ChangeScrollMode();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_EndState();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_GetBuildGun();
	FACTORYGAME_API UClass* Z_Construct_UClass_AFGBuildGun_NoRegister();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_GetBuildGunDelayMessage();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_GetBuildGunDelayPercentage();
	...
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled();
	...
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_SecondaryFire();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_UFGBuildGunState_TickState();
	FACTORYGAME_API UClass* Z_Construct_UClass_AFGBuildGun();
	FACTORYGAME_API UClass* Z_Construct_UClass_AFGEquipment();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_CompareActiveRecipeTo();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_GetAvailableRecipes();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_GetBuildGunStateFor();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_GetCostForRecipe();
	FACTORYGAME_API UScriptStruct* Z_Construct_UScriptStruct_FItemAmount();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_GetCurrentBuildGunDelayMessage();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_GetCurrentBuildGunDelayPercentage();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_GetInventory();
	FACTORYGAME_API UClass* Z_Construct_UClass_UFGInventoryComponent_NoRegister();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_GotoBuildState();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_GotoDismantleState();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_GotoMenuState();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_IsInState();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_Server_GotoBuildState();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_Server_GotoState();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_Server_NoSnapMode();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_Server_PrimaryFire();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_Server_ScrollDown();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_Server_ScrollMode();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_Server_ScrollUp();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildGun_Server_SecondaryFire();
	...
	FACTORYGAME_API UClass* Z_Construct_UClass_AFGBuildGunAttachment_NoRegister();
...
// End Cross Module References
	...
	UFunction* Z_Construct_UDelegateFunction_FactoryGame_OnBuildGunRecipeChanged__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_FactoryGame_OnBuildGunRecipeChanged__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_FactoryGame_OnBuildGunStateChanged__DelegateSignature_Statics
	{
	...
	UFunction* Z_Construct_UDelegateFunction_FactoryGame_OnBuildGunStateChanged__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_FactoryGame_OnBuildGunStateChanged__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	static UEnum* EBuildGunState_StaticEnum()
	{
		static UEnum* Singleton = nullptr;
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_FactoryGame_EBuildGunState, Z_Construct_UPackage__Script_FactoryGame(), TEXT("EBuildGunState"));
		}
		return Singleton;
	}
	...
	uint32 Get_Z_Construct_UEnum_FactoryGame_EBuildGunState_Hash() { return 1530148813U; }
	UEnum* Z_Construct_UEnum_FactoryGame_EBuildGunState()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "EBuildGunState::BGS_NONE", (int64)EBuildGunState::BGS_NONE },
				{ "EBuildGunState::BGS_MENU", (int64)EBuildGunState::BGS_MENU },
				{ "EBuildGunState::BGS_BUILD", (int64)EBuildGunState::BGS_BUILD },
				{ "EBuildGunState::BGS_DISMANTLE", (int64)EBuildGunState::BGS_DISMANTLE },
				{ "EBuildGunState::BGS_MAX", (int64)EBuildGunState::BGS_MAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BGS_BUILD.DisplayName", "Build" },
				{ "BGS_DISMANTLE.DisplayName", "Dismantle" },
				{ "BGS_MAX.Hidden", "" },
	...
	static FName NAME_UFGBuildGunState_BeginState = FName(TEXT("BeginState"));
	void UFGBuildGunState::BeginState()
	{
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_BeginState),NULL);
	}
	static FName NAME_UFGBuildGunState_BuildSamplePressed = FName(TEXT("BuildSamplePressed"));
	void UFGBuildGunState::BuildSamplePressed()
	{
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_BuildSamplePressed),NULL);
	}
	static FName NAME_UFGBuildGunState_BuildSampleRelease = FName(TEXT("BuildSampleRelease"));
	void UFGBuildGunState::BuildSampleRelease()
	{
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_BuildSampleRelease),NULL);
	}
	static FName NAME_UFGBuildGunState_ChangeGuideLinesSnapMode = FName(TEXT("ChangeGuideLinesSnapMode"));
	void UFGBuildGunState::ChangeGuideLinesSnapMode(bool enabled)
	{
		FGBuildGunState_eventChangeGuideLinesSnapMode_Parms Parms;
		Parms.enabled=enabled ? true : false;
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_ChangeGuideLinesSnapMode),&Parms);
	}
	static FName NAME_UFGBuildGunState_ChangeNoSnapMode = FName(TEXT("ChangeNoSnapMode"));
	void UFGBuildGunState::ChangeNoSnapMode()
	{
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_ChangeNoSnapMode),NULL);
	}
	static FName NAME_UFGBuildGunState_ChangeScrollMode = FName(TEXT("ChangeScrollMode"));
	void UFGBuildGunState::ChangeScrollMode()
	{
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_ChangeScrollMode),NULL);
	}
	static FName NAME_UFGBuildGunState_EndState = FName(TEXT("EndState"));
	...
	static FName NAME_UFGBuildGunState_OnRecipeSampled = FName(TEXT("OnRecipeSampled"));
	void UFGBuildGunState::OnRecipeSampled(TSubclassOf<UFGRecipe>  recipe)
	{
		FGBuildGunState_eventOnRecipeSampled_Parms Parms;
		Parms.recipe=recipe;
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_OnRecipeSampled),&Parms);
	}
	...
	{
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_ScrollDown),NULL);
	}
	static FName NAME_UFGBuildGunState_ScrollUp = FName(TEXT("ScrollUp"));
	void UFGBuildGunState::ScrollUp()
	{
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_ScrollUp),NULL);
	}
	static FName NAME_UFGBuildGunState_SecondaryFire = FName(TEXT("SecondaryFire"));
	void UFGBuildGunState::SecondaryFire()
	{
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_SecondaryFire),NULL);
	}
	static FName NAME_UFGBuildGunState_TickState = FName(TEXT("TickState"));
	void UFGBuildGunState::TickState(float deltaTime)
	{
		FGBuildGunState_eventTickState_Parms Parms;
		Parms.deltaTime=deltaTime;
		ProcessEvent(FindFunctionChecked(NAME_UFGBuildGunState_TickState),&Parms);
	}
	void UFGBuildGunState::StaticRegisterNativesUFGBuildGunState()
	{
		UClass* Class = UFGBuildGunState::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "BeginBuildGunDelay", &UFGBuildGunState::execBeginBuildGunDelay },
			{ "BeginState", &UFGBuildGunState::execBeginState },
			{ "BuildGunDelayIsComplete", &UFGBuildGunState::execBuildGunDelayIsComplete },
			{ "BuildSamplePressed", &UFGBuildGunState::execBuildSamplePressed },
			{ "BuildSampleRelease", &UFGBuildGunState::execBuildSampleRelease },
			{ "ChangeGuideLinesSnapMode", &UFGBuildGunState::execChangeGuideLinesSnapMode },
			{ "ChangeNoSnapMode", &UFGBuildGunState::execChangeNoSnapMode },
			{ "ChangeScrollMode", &UFGBuildGunState::execChangeScrollMode },
			{ "EndState", &UFGBuildGunState::execEndState },
			{ "GetBuildGun", &UFGBuildGunState::execGetBuildGun },
			{ "GetBuildGunDelayMessage", &UFGBuildGunState::execGetBuildGunDelayMessage },
			{ "GetBuildGunDelayPercentage", &UFGBuildGunState::execGetBuildGunDelayPercentage },
			...
			{ "OnRecipeSampled", &UFGBuildGunState::execOnRecipeSampled },
			...
			{ "SecondaryFire", &UFGBuildGunState::execSecondaryFire },
			{ "TickState", &UFGBuildGunState::execTickState },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UFGBuildGunState_BeginBuildGunDelay_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_BeginBuildGunDelay()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_BeginBuildGunDelay_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_BeginState_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_BeginState()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_BeginState_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_BuildGunDelayIsComplete_Statics
	{
		struct FGBuildGunState_eventBuildGunDelayIsComplete_Parms
		{
			bool ReturnValue;
		};
	...
	void Z_Construct_UFunction_UFGBuildGunState_BuildGunDelayIsComplete_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_BuildGunDelayIsComplete()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_BuildGunDelayIsComplete_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_BuildSamplePressed_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFGBuildGunState_BuildSamplePressed_Statics::Function_MetaDataParams[] = {
		{ "Category", "BuildGunState" },
		{ "ModuleRelativePath", "Public/Equipment/FGBuildGun.h" },
		{ "ToolTip", "Redirected from the build gun." },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGBuildGunState_BuildSamplePressed_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGBuildGunState, nullptr, "BuildSamplePressed", 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGBuildGunState_BuildSamplePressed_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGBuildGunState_BuildSamplePressed_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFGBuildGunState_BuildSamplePressed()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_BuildSamplePressed_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_BuildSampleRelease_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFGBuildGunState_BuildSampleRelease_Statics::Function_MetaDataParams[] = {
		{ "Category", "BuildGunState" },
		{ "ModuleRelativePath", "Public/Equipment/FGBuildGun.h" },
		{ "ToolTip", "Redirected from the build gun." },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGBuildGunState_BuildSampleRelease_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGBuildGunState, nullptr, "BuildSampleRelease", 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGBuildGunState_BuildSampleRelease_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGBuildGunState_BuildSampleRelease_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFGBuildGunState_BuildSampleRelease()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_BuildSampleRelease_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_ChangeGuideLinesSnapMode_Statics
	{
	...
	void Z_Construct_UFunction_UFGBuildGunState_ChangeGuideLinesSnapMode_Statics::NewProp_enabled_SetBit(void* Obj)
	{
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_ChangeGuideLinesSnapMode()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_ChangeGuideLinesSnapMode_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_ChangeNoSnapMode_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_ChangeNoSnapMode()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_ChangeNoSnapMode_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_ChangeScrollMode_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_ChangeScrollMode()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_ChangeScrollMode_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_EndState_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_EndState()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_EndState_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_GetBuildGun_Statics
	{
		struct FGBuildGunState_eventGetBuildGun_Parms
		{
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_GetBuildGun()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_GetBuildGun_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_GetBuildGunDelayMessage_Statics
	{
		struct FGBuildGunState_eventGetBuildGunDelayMessage_Parms
		{
			FText ReturnValue;
		};
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_GetBuildGunDelayMessage()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_GetBuildGunDelayMessage_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_GetBuildGunDelayPercentage_Statics
	{
		struct FGBuildGunState_eventGetBuildGunDelayPercentage_Parms
		{
			float ReturnValue;
		};
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_GetBuildGunDelayPercentage()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_GetBuildGunDelayPercentage_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_HasAuthority_Statics
	{
		struct FGBuildGunState_eventHasAuthority_Parms
		{
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_UFGBuildGunState_HasAuthority_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_HasAuthority()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_HasAuthority_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_HasBuildGunDelay_Statics
	{
		struct FGBuildGunState_eventHasBuildGunDelay_Parms
		{
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_UFGBuildGunState_HasBuildGunDelay_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_HasBuildGunDelay()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_HasBuildGunDelay_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_IsActive_Statics
	{
		struct FGBuildGunState_eventIsActive_Parms
		{
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_UFGBuildGunState_IsActive_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_IsActive()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_IsActive_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics
	{
	...
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics::NewProp_recipe = { "recipe", nullptr, (EPropertyFlags)0x0014000000000080, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGBuildGunState_eventOnRecipeSampled_Parms, recipe), Z_Construct_UClass_UFGRecipe_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics::NewProp_recipe,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics::Function_MetaDataParams[] = {
		{ "Category", "BuildGunState|Build" },
		{ "ModuleRelativePath", "Public/Equipment/FGBuildGun.h" },
		{ "ToolTip", "We have sampled a new recipe" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFGBuildGunState, nullptr, "OnRecipeSampled", sizeof(FGBuildGunState_eventOnRecipeSampled_Parms), Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UFGBuildGunState_ResetBuildGunDelay_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_ResetBuildGunDelay()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_ResetBuildGunDelay_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_ScrollDown_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_ScrollDown()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_ScrollDown_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_ScrollUp_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_ScrollUp()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_ScrollUp_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_SecondaryFire_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_SecondaryFire()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_SecondaryFire_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFGBuildGunState_TickState_Statics
	{
	...
	UFunction* Z_Construct_UFunction_UFGBuildGunState_TickState()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UFGBuildGunState_TickState_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	UClass* Z_Construct_UClass_UFGBuildGunState_NoRegister()
	{
		return UFGBuildGunState::StaticClass();
	}
	struct Z_Construct_UClass_UFGBuildGunState_Statics
	{
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mActionMessage_MetaData[];
#endif
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_mActionMessage;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mActionDelay_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_mActionDelay;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UE4CodeGen_Private::FClassParams ClassParams;
	};
	UObject* (*const Z_Construct_UClass_UFGBuildGunState_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UObject,
		(UObject* (*)())Z_Construct_UPackage__Script_FactoryGame,
	};
	const FClassFunctionLinkInfo Z_Construct_UClass_UFGBuildGunState_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFGBuildGunState_BeginBuildGunDelay, "BeginBuildGunDelay" }, // 1862849918
		{ &Z_Construct_UFunction_UFGBuildGunState_BeginState, "BeginState" }, // 1693571103
		{ &Z_Construct_UFunction_UFGBuildGunState_BuildGunDelayIsComplete, "BuildGunDelayIsComplete" }, // 621571915
		{ &Z_Construct_UFunction_UFGBuildGunState_BuildSamplePressed, "BuildSamplePressed" }, // 2692151592
		{ &Z_Construct_UFunction_UFGBuildGunState_BuildSampleRelease, "BuildSampleRelease" }, // 2323946448
		{ &Z_Construct_UFunction_UFGBuildGunState_ChangeGuideLinesSnapMode, "ChangeGuideLinesSnapMode" }, // 564095188
		{ &Z_Construct_UFunction_UFGBuildGunState_ChangeNoSnapMode, "ChangeNoSnapMode" }, // 1184458808
		{ &Z_Construct_UFunction_UFGBuildGunState_ChangeScrollMode, "ChangeScrollMode" }, // 512437620
		{ &Z_Construct_UFunction_UFGBuildGunState_EndState, "EndState" }, // 1902403555
		{ &Z_Construct_UFunction_UFGBuildGunState_GetBuildGun, "GetBuildGun" }, // 3935036655
		{ &Z_Construct_UFunction_UFGBuildGunState_GetBuildGunDelayMessage, "GetBuildGunDelayMessage" }, // 3276136552
		{ &Z_Construct_UFunction_UFGBuildGunState_GetBuildGunDelayPercentage, "GetBuildGunDelayPercentage" }, // 3738854403
		...
		{ &Z_Construct_UFunction_UFGBuildGunState_OnRecipeSampled, "OnRecipeSampled" }, // 3951316857
		...
		{ &Z_Construct_UFunction_UFGBuildGunState_SecondaryFire, "SecondaryFire" }, // 419340186
		{ &Z_Construct_UFunction_UFGBuildGunState_TickState, "TickState" }, // 3603012843
	};
#if WITH_METADATA
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UFGBuildGunState_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UFGBuildGunState>::IsAbstract,
	};
	...
	UClass* Z_Construct_UClass_UFGBuildGunState()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UFGBuildGunState_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UFGBuildGunState, 1075912927);
	...
	void AFGBuildGun::Server_GotoBuildState(TSubclassOf<UFGRecipe>  recipe)
	{
		FGBuildGun_eventServer_GotoBuildState_Parms Parms;
		Parms.recipe=recipe;
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildGun_Server_GotoBuildState),&Parms);
	}
	static FName NAME_AFGBuildGun_Server_GotoState = FName(TEXT("Server_GotoState"));
	void AFGBuildGun::Server_GotoState(EBuildGunState state)
	{
		FGBuildGun_eventServer_GotoState_Parms Parms;
		Parms.state=state;
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildGun_Server_GotoState),&Parms);
	}
	static FName NAME_AFGBuildGun_Server_NoSnapMode = FName(TEXT("Server_NoSnapMode"));
	void AFGBuildGun::Server_NoSnapMode()
	{
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildGun_Server_NoSnapMode),NULL);
	}
	static FName NAME_AFGBuildGun_Server_PrimaryFire = FName(TEXT("Server_PrimaryFire"));
	void AFGBuildGun::Server_PrimaryFire()
	{
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildGun_Server_PrimaryFire),NULL);
	}
	static FName NAME_AFGBuildGun_Server_ScrollDown = FName(TEXT("Server_ScrollDown"));
	void AFGBuildGun::Server_ScrollDown()
	{
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildGun_Server_ScrollDown),NULL);
	}
	static FName NAME_AFGBuildGun_Server_ScrollMode = FName(TEXT("Server_ScrollMode"));
	void AFGBuildGun::Server_ScrollMode()
	{
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildGun_Server_ScrollMode),NULL);
	}
	static FName NAME_AFGBuildGun_Server_ScrollUp = FName(TEXT("Server_ScrollUp"));
	void AFGBuildGun::Server_ScrollUp()
	{
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildGun_Server_ScrollUp),NULL);
	}
	static FName NAME_AFGBuildGun_Server_SecondaryFire = FName(TEXT("Server_SecondaryFire"));
	void AFGBuildGun::Server_SecondaryFire()
	{
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildGun_Server_SecondaryFire),NULL);
	}
	void AFGBuildGun::StaticRegisterNativesAFGBuildGun()
	{
		UClass* Class = AFGBuildGun::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "CompareActiveRecipeTo", &AFGBuildGun::execCompareActiveRecipeTo },
			{ "GetAvailableRecipes", &AFGBuildGun::execGetAvailableRecipes },
			{ "GetBuildGunStateFor", &AFGBuildGun::execGetBuildGunStateFor },
			{ "GetCostForRecipe", &AFGBuildGun::execGetCostForRecipe },
			{ "GetCurrentBuildGunDelayMessage", &AFGBuildGun::execGetCurrentBuildGunDelayMessage },
			{ "GetCurrentBuildGunDelayPercentage", &AFGBuildGun::execGetCurrentBuildGunDelayPercentage },
			{ "GetInventory", &AFGBuildGun::execGetInventory },
			{ "GotoBuildState", &AFGBuildGun::execGotoBuildState },
			{ "GotoDismantleState", &AFGBuildGun::execGotoDismantleState },
			{ "GotoMenuState", &AFGBuildGun::execGotoMenuState },
			{ "IsInState", &AFGBuildGun::execIsInState },
			{ "Server_GotoBuildState", &AFGBuildGun::execServer_GotoBuildState },
			{ "Server_GotoState", &AFGBuildGun::execServer_GotoState },
			{ "Server_NoSnapMode", &AFGBuildGun::execServer_NoSnapMode },
			{ "Server_PrimaryFire", &AFGBuildGun::execServer_PrimaryFire },
			{ "Server_ScrollDown", &AFGBuildGun::execServer_ScrollDown },
			{ "Server_ScrollMode", &AFGBuildGun::execServer_ScrollMode },
			{ "Server_ScrollUp", &AFGBuildGun::execServer_ScrollUp },
			{ "Server_SecondaryFire", &AFGBuildGun::execServer_SecondaryFire },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_AFGBuildGun_CompareActiveRecipeTo_Statics
	{
		struct FGBuildGun_eventCompareActiveRecipeTo_Parms
		{
	...
	void Z_Construct_UFunction_AFGBuildGun_CompareActiveRecipeTo_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_CompareActiveRecipeTo()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_CompareActiveRecipeTo_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_GetAvailableRecipes_Statics
	{
		struct FGBuildGun_eventGetAvailableRecipes_Parms
		{
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_GetAvailableRecipes()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_GetAvailableRecipes_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_GetBuildGunStateFor_Statics
	{
		struct FGBuildGun_eventGetBuildGunStateFor_Parms
		{
			EBuildGunState gunState;
			UFGBuildGunState* ReturnValue;
		};
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ReturnValue;
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_gunState;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_gunState_Underlying;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFGBuildGun_GetBuildGunStateFor_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildGun_GetBuildGunStateFor_Statics::NewProp_gunState_Underlying,
	};
#if WITH_METADATA
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_GetBuildGunStateFor()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_GetBuildGunStateFor_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_GetCostForRecipe_Statics
	{
		struct FGBuildGun_eventGetCostForRecipe_Parms
		{
			TSubclassOf<UFGRecipe>  recipe;
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFGBuildGun_GetCostForRecipe_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildGun_GetCostForRecipe_Statics::NewProp_recipe,
	};
#if WITH_METADATA
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_GetCostForRecipe()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_GetCostForRecipe_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_GetCurrentBuildGunDelayMessage_Statics
	{
		struct FGBuildGun_eventGetCurrentBuildGunDelayMessage_Parms
		{
			FText ReturnValue;
		};
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_ReturnValue;
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_GetCurrentBuildGunDelayMessage()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_GetCurrentBuildGunDelayMessage_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_GetCurrentBuildGunDelayPercentage_Statics
	{
		struct FGBuildGun_eventGetCurrentBuildGunDelayPercentage_Parms
		{
			float ReturnValue;
		};
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_ReturnValue;
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_GetCurrentBuildGunDelayPercentage()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_GetCurrentBuildGunDelayPercentage_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_GetInventory_Statics
	{
		struct FGBuildGun_eventGetInventory_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildGun_GetInventory_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_GetInventory()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_GetInventory_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_GotoBuildState_Statics
	{
		struct FGBuildGun_eventGotoBuildState_Parms
		{
			TSubclassOf<UFGRecipe>  recipe;
		};
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_recipe;
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_GotoBuildState()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_GotoBuildState_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_GotoDismantleState_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_GotoDismantleState()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_GotoDismantleState_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_GotoMenuState_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_GotoMenuState()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_GotoMenuState_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_IsInState_Statics
	{
		struct FGBuildGun_eventIsInState_Parms
		{
			EBuildGunState inState;
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
	...
	void Z_Construct_UFunction_AFGBuildGun_IsInState_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFGBuildGun_IsInState_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildGun_IsInState_Statics::NewProp_inState_Underlying,
	};
#if WITH_METADATA
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_IsInState()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_IsInState_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_Server_GotoBuildState_Statics
	{
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_recipe;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_Server_GotoBuildState()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_Server_GotoBuildState_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_Server_GotoState_Statics
	{
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_Server_GotoState()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_Server_GotoState_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_Server_NoSnapMode_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_Server_NoSnapMode()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_Server_NoSnapMode_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_Server_PrimaryFire_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_Server_PrimaryFire()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_Server_PrimaryFire_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_Server_ScrollDown_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_Server_ScrollDown()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_Server_ScrollDown_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_Server_ScrollMode_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_Server_ScrollMode()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_Server_ScrollMode_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_Server_ScrollUp_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_Server_ScrollUp()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_Server_ScrollUp_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildGun_Server_SecondaryFire_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildGun_Server_SecondaryFire()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildGun_Server_SecondaryFire_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	UClass* Z_Construct_UClass_AFGBuildGun_NoRegister()
	{
		return AFGBuildGun::StaticClass();
	}
	struct Z_Construct_UClass_AFGBuildGun_Statics
	{
		static UObject* (*const DependentSingletons[])();
		static const FClassFunctionLinkInfo FuncInfo[];
#if WITH_METADATA
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mCurrentState_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_mCurrentState;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mCurrentStateEnum_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_mCurrentStateEnum;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_mCurrentStateEnum_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mHitResult_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_mHitResult;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mStates_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_mStates;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDismantleStateClass_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mDismantleStateClass;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mBuildStateClass_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mBuildStateClass;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mMenuStateClass_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mMenuStateClass;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mBuildDistanceMax_MetaData[];
#endif
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mOnStateChanged_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_mOnStateChanged;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const UE4CodeGen_Private::FImplementedInterfaceParams InterfaceParams[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UE4CodeGen_Private::FClassParams ClassParams;
	};
	UObject* (*const Z_Construct_UClass_AFGBuildGun_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_AFGEquipment,
		(UObject* (*)())Z_Construct_UPackage__Script_FactoryGame,
	};
	const FClassFunctionLinkInfo Z_Construct_UClass_AFGBuildGun_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFGBuildGun_CompareActiveRecipeTo, "CompareActiveRecipeTo" }, // 10422839
		{ &Z_Construct_UFunction_AFGBuildGun_GetAvailableRecipes, "GetAvailableRecipes" }, // 325277245
		{ &Z_Construct_UFunction_AFGBuildGun_GetBuildGunStateFor, "GetBuildGunStateFor" }, // 4047873396
		{ &Z_Construct_UFunction_AFGBuildGun_GetCostForRecipe, "GetCostForRecipe" }, // 3166684828
		{ &Z_Construct_UFunction_AFGBuildGun_GetCurrentBuildGunDelayMessage, "GetCurrentBuildGunDelayMessage" }, // 1893967140
		{ &Z_Construct_UFunction_AFGBuildGun_GetCurrentBuildGunDelayPercentage, "GetCurrentBuildGunDelayPercentage" }, // 1471608962
		{ &Z_Construct_UFunction_AFGBuildGun_GetInventory, "GetInventory" }, // 691075464
		{ &Z_Construct_UFunction_AFGBuildGun_GotoBuildState, "GotoBuildState" }, // 3330523489
		{ &Z_Construct_UFunction_AFGBuildGun_GotoDismantleState, "GotoDismantleState" }, // 1205008697
		{ &Z_Construct_UFunction_AFGBuildGun_GotoMenuState, "GotoMenuState" }, // 1274327976
		{ &Z_Construct_UFunction_AFGBuildGun_IsInState, "IsInState" }, // 2089928553
		{ &Z_Construct_UFunction_AFGBuildGun_Server_GotoBuildState, "Server_GotoBuildState" }, // 2803887500
		{ &Z_Construct_UFunction_AFGBuildGun_Server_GotoState, "Server_GotoState" }, // 4180704307
		{ &Z_Construct_UFunction_AFGBuildGun_Server_NoSnapMode, "Server_NoSnapMode" }, // 2522541463
		{ &Z_Construct_UFunction_AFGBuildGun_Server_PrimaryFire, "Server_PrimaryFire" }, // 117782482
		{ &Z_Construct_UFunction_AFGBuildGun_Server_ScrollDown, "Server_ScrollDown" }, // 286837354
		{ &Z_Construct_UFunction_AFGBuildGun_Server_ScrollMode, "Server_ScrollMode" }, // 3715316029
		{ &Z_Construct_UFunction_AFGBuildGun_Server_ScrollUp, "Server_ScrollUp" }, // 4273755259
		{ &Z_Construct_UFunction_AFGBuildGun_Server_SecondaryFire, "Server_SecondaryFire" }, // 4219294867
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFGBuildGun_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildGun_Statics::NewProp_mCurrentStateEnum_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildGun_Statics::NewProp_mHitResult,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildGun_Statics::NewProp_mStates,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildGun_Statics::NewProp_mDismantleStateClass,
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AFGBuildGun_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UFGRecipeProducerInterface_NoRegister, (int32)VTABLE_OFFSET(AFGBuildGun, IFGRecipeProducerInterface), false },
		};
	const FCppClassTypeInfoStatic Z_Construct_UClass_AFGBuildGun_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<AFGBuildGun>::IsAbstract,
	};
	...
	UClass* Z_Construct_UClass_AFGBuildGun()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AFGBuildGun_Statics::ClassParams);
		}
		return OuterClass;
	}
	...
	UClass* Z_Construct_UClass_AFGBuildGunAttachment_NoRegister()
	{
		return AFGBuildGunAttachment::StaticClass();
	}
	struct Z_Construct_UClass_AFGBuildGunAttachment_Statics
	{
		static UObject* (*const DependentSingletons[])();
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[];
	...
	UObject* (*const Z_Construct_UClass_AFGBuildGunAttachment_Statics::DependentSingletons[])() = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_AFGBuildGunAttachment_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<AFGBuildGunAttachment>::IsAbstract,
	};
	...
	UClass* Z_Construct_UClass_AFGBuildGunAttachment()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AFGBuildGunAttachment_Statics::ClassParams);
		}
		return OuterClass;
	}
