...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFGConveyorBeltHologram_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFGConveyorBeltHologram_OnRep_ConnectionArrowComponentDirection, "OnRep_ConnectionArrowComponentDirection" }, // 1115257777
		{ &Z_Construct_UFunction_AFGConveyorBeltHologram_OnRep_SplineData, "OnRep_SplineData" }, // 3342814071
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConnectionArrowComponent = { UE4CodeGen_Private::EPropertyClass::Object, "mConnectionArrowComponent", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000080008, 1, nullptr, STRUCT_OFFSET(AFGConveyorBeltHologram, mConnectionArrowComponent), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConnectionArrowComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConnectionArrowComponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConnectionArrowComponentDirection = { UE4CodeGen_Private::EPropertyClass::Enum, "mConnectionArrowComponentDirection", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000100000020, 1, "OnRep_ConnectionArrowComponentDirection", STRUCT_OFFSET(AFGConveyorBeltHologram, mConnectionArrowComponentDirection), Z_Construct_UEnum_FactoryGame_EFactoryConnectionDirection, METADATA_PARAMS(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConnectionArrowComponentDirection_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConnectionArrowComponentDirection_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mMaxIncline = { UE4CodeGen_Private::EPropertyClass::Float, "mMaxIncline", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000010001, 1, nullptr, STRUCT_OFFSET(AFGConveyorBeltHologram, mMaxIncline), METADATA_PARAMS(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mMaxIncline_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mMaxIncline_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mMaxLength = { UE4CodeGen_Private::EPropertyClass::Int, "mMaxLength", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000010001, 1, nullptr, STRUCT_OFFSET(AFGConveyorBeltHologram, mMaxLength), METADATA_PARAMS(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mMaxLength_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mMaxLength_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mBendRadius = { UE4CodeGen_Private::EPropertyClass::Float, "mBendRadius", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000010001, 1, nullptr, STRUCT_OFFSET(AFGConveyorBeltHologram, mBendRadius), METADATA_PARAMS(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mBendRadius_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mBendRadius_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mDefaultConveyorPoleRecipe = { UE4CodeGen_Private::EPropertyClass::Class, "mDefaultConveyorPoleRecipe", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0044000000010001, 1, nullptr, STRUCT_OFFSET(AFGConveyorBeltHologram, mDefaultConveyorPoleRecipe), Z_Construct_UClass_UFGRecipe_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mDefaultConveyorPoleRecipe_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mDefaultConveyorPoleRecipe_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mUpgradedConveyorBelt = { UE4CodeGen_Private::EPropertyClass::Object, "mUpgradedConveyorBelt", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000000, 1, nullptr, STRUCT_OFFSET(AFGConveyorBeltHologram, mUpgradedConveyorBelt), Z_Construct_UClass_AFGBuildableConveyorBelt_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mUpgradedConveyorBelt_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mUpgradedConveyorBelt_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConveyorPoles = { UE4CodeGen_Private::EPropertyClass::Object, "mConveyorPoles", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000000020, CPP_ARRAY_DIM(mConveyorPoles, AFGConveyorBeltHologram), nullptr, STRUCT_OFFSET(AFGConveyorBeltHologram, mConveyorPoles), Z_Construct_UClass_AFGConveyorPoleHologram_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConveyorPoles_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConveyorPoles_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConnectionComponents = { UE4CodeGen_Private::EPropertyClass::Object, "mConnectionComponents", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000080008, CPP_ARRAY_DIM(mConnectionComponents, AFGConveyorBeltHologram), nullptr, STRUCT_OFFSET(AFGConveyorBeltHologram, mConnectionComponents), Z_Construct_UClass_UFGFactoryConnectionComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConnectionComponents_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mConnectionComponents_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mSplineData = { UE4CodeGen_Private::EPropertyClass::Array, "mSplineData", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000100000020, 1, "OnRep_SplineData", STRUCT_OFFSET(AFGConveyorBeltHologram, mSplineData), METADATA_PARAMS(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mSplineData_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mSplineData_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::NewProp_mSplineData_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "mSplineData", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FSplinePointData, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AFGConveyorBeltHologram_Statics::ClassParams = {
		...
		Z_Construct_UClass_AFGConveyorBeltHologram_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AFGConveyorBeltHologram_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(AFGConveyorBeltHologram, 1581996176);
