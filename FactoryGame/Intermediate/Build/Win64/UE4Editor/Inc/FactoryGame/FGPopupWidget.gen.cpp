...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_FactoryGame_PopupClosed__DelegateSignature_Statics::NewProp_ConfirmClicked = { "ConfirmClicked", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(_Script_FactoryGame_eventPopupClosed_Parms), &Z_Construct_UDelegateFunction_FactoryGame_PopupClosed__DelegateSignature_Statics::NewProp_ConfirmClicked_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	template<> FACTORYGAME_API UEnum* StaticEnum<EPopupId>()
	{
	...
	UEnum* Z_Construct_UEnum_FactoryGame_EPopupId()
	{
		...
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EPopupId"), 0, Get_Z_Construct_UEnum_FactoryGame_EPopupId_Hash(), false);
#else
...
class UScriptStruct* FPopupData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FACTORYGAME_API uint32 Get_Z_Construct_UScriptStruct_FPopupData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FPopupData, Z_Construct_UPackage__Script_FactoryGame(), TEXT("PopupData"), sizeof(FPopupData), Get_Z_Construct_UScriptStruct_FPopupData_Hash());
	}
	return Singleton;
}
template<> FACTORYGAME_API UScriptStruct* StaticStruct<FPopupData>()
{
	return FPopupData::StaticStruct();
}
...
static struct FScriptStruct_FactoryGame_StaticRegisterNativesFPopupData
{
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FPopupData_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_FactoryGame();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("PopupData"), sizeof(FPopupData), Get_Z_Construct_UScriptStruct_FPopupData_Hash(), false);
#else
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UFGPopupWidget_CallPopupClosedClicked_Statics::NewProp_confirm = { "confirm", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGPopupWidget_eventCallPopupClosedClicked_Parms), &Z_Construct_UFunction_UFGPopupWidget_CallPopupClosedClicked_Statics::NewProp_confirm_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FDelegatePropertyParams Z_Construct_UClass_UFGPopupWidget_Statics::NewProp_mPopupConfirmClickedDelegate = { "mPopupConfirmClickedDelegate", nullptr, (EPropertyFlags)0x0010000020080000, UE4CodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFGPopupWidget, mPopupConfirmClickedDelegate_DEPRECATED), Z_Construct_UDelegateFunction_FactoryGame_PopupConfirmClicked__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UFGPopupWidget_Statics::NewProp_mPopupConfirmClickedDelegate_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFGPopupWidget_Statics::NewProp_mPopupConfirmClickedDelegate_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UFGPopupWidget_Statics::ClassParams = {
		...
		DependentSingletons,
		FuncInfo,
		Z_Construct_UClass_UFGPopupWidget_Statics::PropPointers,
		nullptr,
		ARRAY_COUNT(DependentSingletons),
		ARRAY_COUNT(FuncInfo),
		ARRAY_COUNT(Z_Construct_UClass_UFGPopupWidget_Statics::PropPointers),
		0,
		0x00B010A4u,
