...
void EmptyLinkFunctionForGeneratedCodeFGBuildable() {}
// Cross Module References
	...
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildable_CanBeSampled();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildable_Factory_GrabOutput();
	...
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildable_GetInteractWidgetClass();
	...
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildable_PlayDismantleEffects();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildable_PlayDismantleSound();
	...
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase();
...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_FactoryGame_BuildableDismantledSignature__DelegateSignature_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_FactoryGame_BuildableDismantledSignature__DelegateSignature_Statics::Function_MetaDataParams[] = {
	...
	UFunction* Z_Construct_UDelegateFunction_FactoryGame_BuildableDismantledSignature__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_FactoryGame_BuildableDismantledSignature__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	static FName NAME_AFGBuildable_CanBeSampled = FName(TEXT("CanBeSampled"));
	bool AFGBuildable::CanBeSampled() const
	{
		FGBuildable_eventCanBeSampled_Parms Parms;
		const_cast<AFGBuildable*>(this)->ProcessEvent(FindFunctionChecked(NAME_AFGBuildable_CanBeSampled),&Parms);
		return !!Parms.ReturnValue;
	}
	static FName NAME_AFGBuildable_Factory_GrabOutput = FName(TEXT("Factory_GrabOutput"));
	bool AFGBuildable::Factory_GrabOutput(UFGFactoryConnectionComponent* connection, FInventoryItem& out_item, float& out_OffsetBeyond, TSubclassOf<UFGItemDescriptor>  type)
	{
		FGBuildable_eventFactory_GrabOutput_Parms Parms;
		Parms.connection=connection;
		Parms.out_item=out_item;
		Parms.out_OffsetBeyond=out_OffsetBeyond;
		Parms.type=type;
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildable_Factory_GrabOutput),&Parms);
		out_item=Parms.out_item;
		out_OffsetBeyond=Parms.out_OffsetBeyond;
		return !!Parms.ReturnValue;
	}
	static FName NAME_AFGBuildable_Factory_PeekOutput = FName(TEXT("Factory_PeekOutput"));
	bool AFGBuildable::Factory_PeekOutput(const UFGFactoryConnectionComponent* connection, TArray<FInventoryItem>& out_items, TSubclassOf<UFGItemDescriptor>  type) const
	{
		FGBuildable_eventFactory_PeekOutput_Parms Parms;
		Parms.connection=connection;
		Parms.out_items=out_items;
		Parms.type=type;
		const_cast<AFGBuildable*>(this)->ProcessEvent(FindFunctionChecked(NAME_AFGBuildable_Factory_PeekOutput),&Parms);
		out_items=Parms.out_items;
		return !!Parms.ReturnValue;
	}
	static FName NAME_AFGBuildable_Factory_ReceiveTick = FName(TEXT("Factory_ReceiveTick"));
	void AFGBuildable::Factory_ReceiveTick(float deltaTime)
	{
		FGBuildable_eventFactory_ReceiveTick_Parms Parms;
		Parms.deltaTime=deltaTime;
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildable_Factory_ReceiveTick),&Parms);
	}
	static FName NAME_AFGBuildable_GetDismantleBlueprintReturns = FName(TEXT("GetDismantleBlueprintReturns"));
	void AFGBuildable::GetDismantleBlueprintReturns(TArray<FInventoryStack>& out_returns) const
	{
		FGBuildable_eventGetDismantleBlueprintReturns_Parms Parms;
	...
	{
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildable_PlayConstructSound),NULL);
	}
	static FName NAME_AFGBuildable_PlayDismantleEffects = FName(TEXT("PlayDismantleEffects"));
	void AFGBuildable::PlayDismantleEffects()
	{
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildable_PlayDismantleEffects),NULL);
	}
	static FName NAME_AFGBuildable_PlayDismantleSound = FName(TEXT("PlayDismantleSound"));
	void AFGBuildable::PlayDismantleSound()
	{
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildable_PlayDismantleSound),NULL);
	}
	static FName NAME_AFGBuildable_ShouldBeConsideredForBase = FName(TEXT("ShouldBeConsideredForBase"));
	bool AFGBuildable::ShouldBeConsideredForBase()
	{
		FGBuildable_eventShouldBeConsideredForBase_Parms Parms;
		ProcessEvent(FindFunctionChecked(NAME_AFGBuildable_ShouldBeConsideredForBase),&Parms);
		return !!Parms.ReturnValue;
	}
	void AFGBuildable::StaticRegisterNativesAFGBuildable()
	{
		UClass* Class = AFGBuildable::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "PlayDismantleSound", &AFGBuildable::execPlayDismantleSound },
			{ "ReapplyColorSlot", &AFGBuildable::execReapplyColorSlot },
			{ "RemoveHighlightEffect", &AFGBuildable::execRemoveHighlightEffect },
#if WITH_EDITOR
			{ "SetBuildableDisplayName", &AFGBuildable::execSetBuildableDisplayName },
#endif // WITH_EDITOR
			{ "ShouldBeConsideredForBase", &AFGBuildable::execShouldBeConsideredForBase },
			{ "ShowHighlightEffect", &AFGBuildable::execShowHighlightEffect },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics
	{
	...
	void Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((FGBuildable_eventCanBeSampled_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGBuildable_eventCanBeSampled_Parms), &Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "ToolTip", "Returns true if this buildable can be sampled" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFGBuildable, nullptr, "CanBeSampled", sizeof(FGBuildable_eventCanBeSampled_Parms), Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x48020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFGBuildable_CanBeSampled()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_CanBeSampled_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_Factory_GrabOutput_Statics
	{
		static void NewProp_ReturnValue_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
	...
	void Z_Construct_UFunction_AFGBuildable_Factory_GrabOutput_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFGBuildable_Factory_GrabOutput_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildable_Factory_GrabOutput_Statics::NewProp_out_OffsetBeyond,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildable_Factory_GrabOutput_Statics::NewProp_out_item,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildable_Factory_GrabOutput_Statics::NewProp_connection,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_Factory_GrabOutput_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable|Connections" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_Factory_GrabOutput()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_Factory_GrabOutput_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_Factory_PeekOutput_Statics
	{
		static void NewProp_ReturnValue_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_type;
	...
	void Z_Construct_UFunction_AFGBuildable_Factory_PeekOutput_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFGBuildable_Factory_PeekOutput_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildable_Factory_PeekOutput_Statics::NewProp_out_items,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildable_Factory_PeekOutput_Statics::NewProp_out_items_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildable_Factory_PeekOutput_Statics::NewProp_connection,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_Factory_PeekOutput_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable|Connections" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_Factory_PeekOutput()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_Factory_PeekOutput_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_Factory_ReceiveTick_Statics
	{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_Factory_ReceiveTick_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tick" },
		{ "DisplayName", "Factory_Tick" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_Factory_ReceiveTick()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_Factory_ReceiveTick_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_GetClearanceComponent_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_GetClearanceComponent_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_GetClearanceComponent()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_GetClearanceComponent_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_GetDismantleBlueprintReturns_Statics
	{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_GetDismantleBlueprintReturns_Statics::Function_MetaDataParams[] = {
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_GetDismantleBlueprintReturns()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_GetDismantleBlueprintReturns_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_GetInteractWidgetClass_Statics
	{
		struct FGBuildable_eventGetInteractWidgetClass_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_GetInteractWidgetClass_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable|Interaction" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_GetInteractWidgetClass()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_GetInteractWidgetClass_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_GetMainMeshes_Statics
	{
		struct FGBuildable_eventGetMainMeshes_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_GetMainMeshes_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
		{ "NativeConst", "" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_GetMainMeshes_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_GetMainMeshes()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_GetMainMeshes_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_GetNumPowerConnections_Statics
	{
		struct FGBuildable_eventGetNumPowerConnections_Parms
		{
			uint8 ReturnValue;
		};
	...
	struct Z_Construct_UFunction_AFGBuildable_OnRep_ColorSlot_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_OnRep_ColorSlot_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_OnRep_ColorSlot()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_OnRep_ColorSlot_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_OnRep_DidFirstTimeUse_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_OnRep_DidFirstTimeUse_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	struct Z_Construct_UFunction_AFGBuildable_PlayBuildEffects_Statics
	{
		struct FGBuildable_eventPlayBuildEffects_Parms
		{
			AActor* inInstigator;
		};
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_PlayBuildEffects_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable|Build Effect" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_PlayBuildEffects()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_PlayBuildEffects_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_PlayConstructSound_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_PlayConstructSound_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable|Build Effect" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_PlayConstructSound()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_PlayConstructSound_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_PlayDismantleEffects_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_PlayDismantleEffects_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_PlayDismantleEffects()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_PlayDismantleEffects_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_PlayDismantleSound_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_PlayDismantleSound_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable|Build Effect" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_PlayDismantleSound()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_PlayDismantleSound_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_ReapplyColorSlot_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_ReapplyColorSlot_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_ReapplyColorSlot()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_ReapplyColorSlot_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_RemoveHighlightEffect_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_RemoveHighlightEffect_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_RemoveHighlightEffect()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_RemoveHighlightEffect_Statics::FuncParams);
		}
		return ReturnFunction;
	}
#if WITH_EDITOR
	struct Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics
	{
		struct FGBuildable_eventSetBuildableDisplayName_Parms
		{
	...
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::NewProp_displayName = { "displayName", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGBuildable_eventSetBuildableDisplayName_Parms, displayName), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::NewProp_inClass = { "inClass", nullptr, (EPropertyFlags)0x0014000000000080, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGBuildable_eventSetBuildableDisplayName_Parms, inClass), Z_Construct_UClass_AFGBuildable_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::NewProp_displayName,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::NewProp_inClass,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::Function_MetaDataParams[] = {
		{ "Category", "Editor|Buildable" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "ToolTip", "Sets the display name for this buildable. Only for editor use" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFGBuildable, nullptr, "SetBuildableDisplayName", sizeof(FGBuildable_eventSetBuildableDisplayName_Parms), Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x24022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName_Statics::FuncParams);
		}
		return ReturnFunction;
	}
#endif //WITH_EDITOR
	struct Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics
	{
		static void NewProp_ReturnValue_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	void Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((FGBuildable_eventShouldBeConsideredForBase_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGBuildable_eventShouldBeConsideredForBase_Parms), &Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "ToolTip", "Should this buildable be relevant when considering if a location is near a base/factory area" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFGBuildable, nullptr, "ShouldBeConsideredForBase", sizeof(FGBuildable_eventShouldBeConsideredForBase_Parms), Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGBuildable_ShowHighlightEffect_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGBuildable_ShowHighlightEffect_Statics::Function_MetaDataParams[] = {
		{ "Category", "Buildable" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	...
	UFunction* Z_Construct_UFunction_AFGBuildable_ShowHighlightEffect()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGBuildable_ShowHighlightEffect_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	UClass* Z_Construct_UClass_AFGBuildable_NoRegister()
	{
		return AFGBuildable::StaticClass();
	}
	struct Z_Construct_UClass_AFGBuildable_Statics
	{
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mBuildTimeStamp_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_mBuildTimeStamp;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mBuildingID_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_mBuildingID;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mCameraDistanceSq_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_mCameraDistanceSq;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mAllowCleranceSeparationEvenIfStackedOn_MetaData[];
#endif
		static void NewProp_mAllowCleranceSeparationEvenIfStackedOn_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mAllowCleranceSeparationEvenIfStackedOn;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mShouldShowHighlight_MetaData[];
#endif
		static void NewProp_mShouldShowHighlight_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mShouldShowHighlight;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDidFirstTimeUse_MetaData[];
#endif
		static void NewProp_mDidFirstTimeUse_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mDidFirstTimeUse;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mHighlightParticleClassName_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_mHighlightParticleClassName;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mForceNetUpdateOnRegisterPlayer_MetaData[];
#endif
		static void NewProp_mForceNetUpdateOnRegisterPlayer_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mForceNetUpdateOnRegisterPlayer;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mBuildEffectSpeed_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_mBuildEffectSpeed;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mSkipBuildEffect_MetaData[];
#endif
		static void NewProp_mSkipBuildEffect_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mSkipBuildEffect;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mBuildEffectClassName_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_mBuildEffectClassName;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDismantleEffectClassName_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_mDismantleEffectClassName;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mBuildEffectInstignator_MetaData[];
#endif
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mBuildEffectTemplate_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mBuildEffectTemplate;
#if WITH_METADATA
	...
	UObject* (*const Z_Construct_UClass_AFGBuildable_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_AActor,
		(UObject* (*)())Z_Construct_UPackage__Script_FactoryGame,
	};
	const FClassFunctionLinkInfo Z_Construct_UClass_AFGBuildable_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFGBuildable_CanBeSampled, "CanBeSampled" }, // 4281214487
		...
		{ &Z_Construct_UFunction_AFGBuildable_PlayConstructSound, "PlayConstructSound" }, // 3980785889
		{ &Z_Construct_UFunction_AFGBuildable_PlayDismantleEffects, "PlayDismantleEffects" }, // 369788939
		{ &Z_Construct_UFunction_AFGBuildable_PlayDismantleSound, "PlayDismantleSound" }, // 1831215285
		{ &Z_Construct_UFunction_AFGBuildable_ReapplyColorSlot, "ReapplyColorSlot" }, // 3910453491
		{ &Z_Construct_UFunction_AFGBuildable_RemoveHighlightEffect, "RemoveHighlightEffect" }, // 1750409208
#if WITH_EDITOR
		{ &Z_Construct_UFunction_AFGBuildable_SetBuildableDisplayName, "SetBuildableDisplayName" }, // 911655052
#endif //WITH_EDITOR
		{ &Z_Construct_UFunction_AFGBuildable_ShouldBeConsideredForBase, "ShouldBeConsideredForBase" }, // 441051010
		{ &Z_Construct_UFunction_AFGBuildable_ShowHighlightEffect, "ShowHighlightEffect" }, // 3338263692
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGBuildable_Statics::Class_MetaDataParams[] = {
		{ "AutoJson", "TRUE" },
		{ "IncludePath", "Buildables/FGBuildable.h" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "SerializeToFArchive", "" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGBuildable_Statics::NewProp_mCachedShapeComponent_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "ToolTip", "Caching the shape component once we have gotten it" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGBuildable_Statics::NewProp_mBuiltWithRecipe_MetaData[] = {
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "ToolTip", "Recipe this building was built with, e.g. used for refunds and stats." },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGBuildable_Statics::NewProp_mNetConstructionID_MetaData[] = {
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "ToolTip", "ID given from server when constructed. Has not been assigned a value by server if 0." },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFGBuildable_Statics::NewProp_mNetConstructionID = { "mNetConstructionID", nullptr, (EPropertyFlags)0x0040000000002020, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFGBuildable, mNetConstructionID), Z_Construct_UScriptStruct_FNetConstructionID, METADATA_PARAMS(Z_Construct_UClass_AFGBuildable_Statics::NewProp_mNetConstructionID_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGBuildable_Statics::NewProp_mNetConstructionID_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGBuildable_Statics::NewProp_mAllowCleranceSeparationEvenIfStackedOn_MetaData[] = {
		{ "Category", "Stacking" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
	};
#endif
	void Z_Construct_UClass_AFGBuildable_Statics::NewProp_mAllowCleranceSeparationEvenIfStackedOn_SetBit(void* Obj)
	{
		((AFGBuildable*)Obj)->mAllowCleranceSeparationEvenIfStackedOn = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AFGBuildable_Statics::NewProp_mAllowCleranceSeparationEvenIfStackedOn = { "mAllowCleranceSeparationEvenIfStackedOn", nullptr, (EPropertyFlags)0x0020080000010001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AFGBuildable), &Z_Construct_UClass_AFGBuildable_Statics::NewProp_mAllowCleranceSeparationEvenIfStackedOn_SetBit, METADATA_PARAMS(Z_Construct_UClass_AFGBuildable_Statics::NewProp_mAllowCleranceSeparationEvenIfStackedOn_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGBuildable_Statics::NewProp_mAllowCleranceSeparationEvenIfStackedOn_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGBuildable_Statics::NewProp_mShouldShowHighlight_MetaData[] = {
		{ "Category", "Buildable" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "ToolTip", "Should we show highlight when building this building" },
	};
#endif
	void Z_Construct_UClass_AFGBuildable_Statics::NewProp_mShouldShowHighlight_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGBuildable_Statics::NewProp_mDidFirstTimeUse_MetaData[] = {
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "NoAutoJson", "TRUE" },
		{ "ToolTip", "If this building should show highlight before first use, save when it has been shown" },
	};
#endif
	void Z_Construct_UClass_AFGBuildable_Statics::NewProp_mDidFirstTimeUse_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGBuildable_Statics::NewProp_mForceNetUpdateOnRegisterPlayer_MetaData[] = {
		...
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "ToolTip", "Whether or not this building should use ForceNetUpdate() when a player registers/unregisters from it." },
	};
#endif
	void Z_Construct_UClass_AFGBuildable_Statics::NewProp_mForceNetUpdateOnRegisterPlayer_SetBit(void* Obj)
	{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGBuildable_Statics::NewProp_mSkipBuildEffect_MetaData[] = {
		{ "Category", "Build Effect" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "ToolTip", "Skip the build effect." },
	};
#endif
	void Z_Construct_UClass_AFGBuildable_Statics::NewProp_mSkipBuildEffect_SetBit(void* Obj)
	{
		((AFGBuildable*)Obj)->mSkipBuildEffect = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AFGBuildable_Statics::NewProp_mSkipBuildEffect = { "mSkipBuildEffect", nullptr, (EPropertyFlags)0x0020080000010001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AFGBuildable), &Z_Construct_UClass_AFGBuildable_Statics::NewProp_mSkipBuildEffect_SetBit, METADATA_PARAMS(Z_Construct_UClass_AFGBuildable_Statics::NewProp_mSkipBuildEffect_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGBuildable_Statics::NewProp_mSkipBuildEffect_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_AFGBuildable_Statics::NewProp_mColorSlot = { "mColorSlot", "OnRep_ColorSlot", (EPropertyFlags)0x0020080101000021, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFGBuildable, mColorSlot), nullptr, METADATA_PARAMS(Z_Construct_UClass_AFGBuildable_Statics::NewProp_mColorSlot_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGBuildable_Statics::NewProp_mColorSlot_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGBuildable_Statics::NewProp_mHighlightVector_MetaData[] = {
		{ "Category", "Buildable" },
		{ "ModuleRelativePath", "Public/Buildables/FGBuildable.h" },
		{ "ToolTip", "Vector used to determine highlight effects location" },
	};
#endif
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFGBuildable_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mNetConstructionID,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mCameraDistanceSq,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mAllowCleranceSeparationEvenIfStackedOn,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mShouldShowHighlight,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mDidFirstTimeUse,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mHighlightParticleSystemComponent,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mHighlightParticleSystemTemplate,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mHighlightParticleClassName,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mForceNetUpdateOnRegisterPlayer,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mBuildEffectSpeed,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGBuildable_Statics::NewProp_mSkipBuildEffect,
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AFGBuildable_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UFGDismantleInterface_NoRegister, (int32)VTABLE_OFFSET(AFGBuildable, IFGDismantleInterface), false },
			{ Z_Construct_UClass_UFGSaveInterface_NoRegister, (int32)VTABLE_OFFSET(AFGBuildable, IFGSaveInterface), false },
			{ Z_Construct_UClass_UFGColorInterface_NoRegister, (int32)VTABLE_OFFSET(AFGBuildable, IFGColorInterface), false },
			{ Z_Construct_UClass_UFGUseableInterface_NoRegister, (int32)VTABLE_OFFSET(AFGBuildable, IFGUseableInterface), false },
		};
	const FCppClassTypeInfoStatic Z_Construct_UClass_AFGBuildable_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<AFGBuildable>::IsAbstract,
	};
	...
	UClass* Z_Construct_UClass_AFGBuildable()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AFGBuildable_Statics::ClassParams);
		}
		return OuterClass;
	}
