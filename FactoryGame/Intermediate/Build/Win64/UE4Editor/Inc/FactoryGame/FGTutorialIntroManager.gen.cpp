...
#include "FactoryGame/Public/FGTutorialIntroManager.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeFGTutorialIntroManager() {}
// Cross Module References
	FACTORYGAME_API UFunction* Z_Construct_UDelegateFunction_FactoryGame_IntroSequenceStateUpdate__DelegateSignature();
	UPackage* Z_Construct_UPackage__Script_FactoryGame();
	FACTORYGAME_API UEnum* Z_Construct_UEnum_FactoryGame_EIntroTutorialSteps();
	...
	FACTORYGAME_API UScriptStruct* Z_Construct_UScriptStruct_FRecipeAmountPair();
	...
	FACTORYGAME_API UClass* Z_Construct_UClass_AFGTutorialIntroManager();
	FACTORYGAME_API UClass* Z_Construct_UClass_AFGSubsystem();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_CancelSkipIntroSequence();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_CompleteTutorial();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_EndSkipIntroSequence();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_Get();
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject_NoRegister();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetCanSkipTutorial();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetCurrentTutorialStep();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetIsIntroSequenceDone();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetIsTutorialCompleted();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetNormalizedProgressToSkip();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetTradingPostLevel();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_HasTradingpostBeenBuilt();
	...
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_OnRep_TradingPostLevel();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_OnSchematicPurchased();
	FACTORYGAME_API UClass* Z_Construct_UClass_UFGSchematic_NoRegister();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_SetCanSkipTutorialIntro();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_SetInputGatesFromTutorialLevel();
	FACTORYGAME_API UClass* Z_Construct_UClass_AFGPlayerController_NoRegister();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_StartSkipIntroSequence();
	FACTORYGAME_API UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_UpdateTutorial();
...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_FactoryGame_IntroSequenceStateUpdate__DelegateSignature_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_FactoryGame_IntroSequenceStateUpdate__DelegateSignature_Statics::Function_MetaDataParams[] = {
	...
	UFunction* Z_Construct_UDelegateFunction_FactoryGame_IntroSequenceStateUpdate__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_FactoryGame_IntroSequenceStateUpdate__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	static UEnum* EIntroTutorialSteps_StaticEnum()
	{
		static UEnum* Singleton = nullptr;
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_FactoryGame_EIntroTutorialSteps, Z_Construct_UPackage__Script_FactoryGame(), TEXT("EIntroTutorialSteps"));
		}
		return Singleton;
	}
	...
	UEnum* Z_Construct_UEnum_FactoryGame_EIntroTutorialSteps()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EIntroTutorialSteps::ITS_HUB_LVL1", (int64)EIntroTutorialSteps::ITS_HUB_LVL1 },
				{ "EIntroTutorialSteps::ITS_HUB_LVL1_5", (int64)EIntroTutorialSteps::ITS_HUB_LVL1_5 },
				{ "EIntroTutorialSteps::ITS_HUB_LVL2", (int64)EIntroTutorialSteps::ITS_HUB_LVL2 },
				{ "EIntroTutorialSteps::ITS_HUB_LVL3", (int64)EIntroTutorialSteps::ITS_HUB_LVL3 },
				{ "EIntroTutorialSteps::ITS_HUB_LVL4", (int64)EIntroTutorialSteps::ITS_HUB_LVL4 },
				{ "EIntroTutorialSteps::ITS_HUB_LVL5", (int64)EIntroTutorialSteps::ITS_HUB_LVL5 },
				{ "EIntroTutorialSteps::ITS_DONE", (int64)EIntroTutorialSteps::ITS_DONE },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "ITS_DISMANTLE_POD.DisplayName", "Dismantle drop pod" },
				{ "ITS_DONE.DisplayName", "Done with intro" },
				{ "ITS_HUB.DisplayName", "Build a hub" },
				{ "ITS_HUB_LVL1.DisplayName", "Upgrade Hub to lvl 1" },
				{ "ITS_HUB_LVL1_5.DisplayName", "Upgrade Hub to lvl 1.5" },
				{ "ITS_HUB_LVL2.DisplayName", "Upgrade Hub to lvl 2" },
				{ "ITS_HUB_LVL3.DisplayName", "Upgrade Hub to lvl 3" },
				{ "ITS_HUB_LVL4.DisplayName", "Upgrade Hub to lvl 4" },
				{ "ITS_HUB_LVL5.DisplayName", "Upgrade Hub to lvl 5" },
...
class UScriptStruct* FTutorialHintData::StaticStruct()
{
...
{
	FScriptStruct_FactoryGame_StaticRegisterNativesFTutorialHintData()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("TutorialHintData")),new UScriptStruct::TCppStructOps<FTutorialHintData>);
	}
} ScriptStruct_FactoryGame_StaticRegisterNativesFTutorialHintData;
	struct Z_Construct_UScriptStruct_FTutorialHintData_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_HintTexts_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_HintTexts;
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_HintTexts_Inner;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FTutorialHintData_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FTutorialHintData_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FTutorialHintData>();
	}
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FTutorialHintData_Statics::NewProp_Message_MetaData[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FTutorialHintData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FTutorialHintData_Statics::NewProp_HintTexts_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FTutorialHintData_Statics::NewProp_Title,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FTutorialHintData_Statics::NewProp_ID,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FTutorialHintData_Statics::NewProp_ID_Underlying,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTutorialHintData_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_FactoryGame,
		nullptr,
		&NewStructOps,
		"TutorialHintData",
	...
	UScriptStruct* Z_Construct_UScriptStruct_FTutorialHintData()
	{
		...
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FTutorialHintData_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FTutorialHintData_Hash() { return 4077401978U; }
class UScriptStruct* FRecipeAmountPair::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern FACTORYGAME_API uint32 Get_Z_Construct_UScriptStruct_FRecipeAmountPair_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FRecipeAmountPair, Z_Construct_UPackage__Script_FactoryGame(), TEXT("RecipeAmountPair"), sizeof(FRecipeAmountPair), Get_Z_Construct_UScriptStruct_FRecipeAmountPair_Hash());
	}
	return Singleton;
}
template<> FACTORYGAME_API UScriptStruct* StaticStruct<FRecipeAmountPair>()
{
	return FRecipeAmountPair::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FRecipeAmountPair(FRecipeAmountPair::StaticStruct, TEXT("/Script/FactoryGame"), TEXT("RecipeAmountPair"), false, nullptr, nullptr);
static struct FScriptStruct_FactoryGame_StaticRegisterNativesFRecipeAmountPair
{
	FScriptStruct_FactoryGame_StaticRegisterNativesFRecipeAmountPair()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("RecipeAmountPair")),new UScriptStruct::TCppStructOps<FRecipeAmountPair>);
	}
} ScriptStruct_FactoryGame_StaticRegisterNativesFRecipeAmountPair;
	struct Z_Construct_UScriptStruct_FRecipeAmountPair_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FRecipeAmountPair>();
	}
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewProp_Amount_MetaData[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "How many of given recipe" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewProp_Amount = { "Amount", nullptr, (EPropertyFlags)0x0010000000010001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRecipeAmountPair, Amount), METADATA_PARAMS(Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewProp_Amount_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewProp_Amount_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewProp_Recipe_MetaData[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Recipe to give player" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewProp_Recipe = { "Recipe", nullptr, (EPropertyFlags)0x0014000000010001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRecipeAmountPair, Recipe), Z_Construct_UClass_UFGRecipe_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewProp_Recipe_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewProp_Recipe_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewProp_Amount,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::NewProp_Recipe,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_FactoryGame,
		nullptr,
		&NewStructOps,
		"RecipeAmountPair",
		sizeof(FRecipeAmountPair),
		alignof(FRecipeAmountPair),
		Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::PropPointers,
		ARRAY_COUNT(Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::Struct_MetaDataParams))
	};
	UScriptStruct* Z_Construct_UScriptStruct_FRecipeAmountPair()
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FRecipeAmountPair_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_FactoryGame();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("RecipeAmountPair"), sizeof(FRecipeAmountPair), Get_Z_Construct_UScriptStruct_FRecipeAmountPair_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FRecipeAmountPair_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FRecipeAmountPair_Hash() { return 335652170U; }
	void AFGTutorialIntroManager::StaticRegisterNativesAFGTutorialIntroManager()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "CancelSkipIntroSequence", &AFGTutorialIntroManager::execCancelSkipIntroSequence },
			{ "CompleteTutorial", &AFGTutorialIntroManager::execCompleteTutorial },
			{ "EndSkipIntroSequence", &AFGTutorialIntroManager::execEndSkipIntroSequence },
			{ "Get", &AFGTutorialIntroManager::execGet },
			{ "GetCanSkipTutorial", &AFGTutorialIntroManager::execGetCanSkipTutorial },
			{ "GetCurrentTutorialStep", &AFGTutorialIntroManager::execGetCurrentTutorialStep },
			{ "GetIsIntroSequenceDone", &AFGTutorialIntroManager::execGetIsIntroSequenceDone },
			{ "GetIsTutorialCompleted", &AFGTutorialIntroManager::execGetIsTutorialCompleted },
			{ "GetNormalizedProgressToSkip", &AFGTutorialIntroManager::execGetNormalizedProgressToSkip },
			{ "GetTradingPostLevel", &AFGTutorialIntroManager::execGetTradingPostLevel },
			...
			{ "OnSchematicPurchased", &AFGTutorialIntroManager::execOnSchematicPurchased },
			{ "SetCanSkipTutorialIntro", &AFGTutorialIntroManager::execSetCanSkipTutorialIntro },
			{ "SetInputGatesFromTutorialLevel", &AFGTutorialIntroManager::execSetInputGatesFromTutorialLevel },
			{ "StartSkipIntroSequence", &AFGTutorialIntroManager::execStartSkipIntroSequence },
			{ "UpdateTutorial", &AFGTutorialIntroManager::execUpdateTutorial },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_CancelSkipIntroSequence_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_CancelSkipIntroSequence_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_CancelSkipIntroSequence()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_CancelSkipIntroSequence_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_CompleteTutorial_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_CompleteTutorial_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_CompleteTutorial()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_CompleteTutorial_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_EndSkipIntroSequence_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_EndSkipIntroSequence_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_EndSkipIntroSequence()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_EndSkipIntroSequence_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_Get_Statics
	{
		struct FGTutorialIntroManager_eventGet_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_Get_Statics::Function_MetaDataParams[] = {
		{ "Category", "TutorialIntroManager" },
		{ "DefaultToSelf", "worldContext" },
		{ "DisplayName", "GetTutorialIntroManager" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_Get()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_Get_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_GetCanSkipTutorial_Statics
	{
		struct FGTutorialIntroManager_eventGetCanSkipTutorial_Parms
		{
			bool ReturnValue;
		};
	...
	void Z_Construct_UFunction_AFGTutorialIntroManager_GetCanSkipTutorial_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_GetCanSkipTutorial_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetCanSkipTutorial()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_GetCanSkipTutorial_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_GetCurrentTutorialStep_Statics
	{
		struct FGTutorialIntroManager_eventGetCurrentTutorialStep_Parms
		{
			EIntroTutorialSteps ReturnValue;
		};
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_GetCurrentTutorialStep_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetCurrentTutorialStep()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_GetCurrentTutorialStep_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_GetIsIntroSequenceDone_Statics
	{
		struct FGTutorialIntroManager_eventGetIsIntroSequenceDone_Parms
		{
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_AFGTutorialIntroManager_GetIsIntroSequenceDone_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_GetIsIntroSequenceDone_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetIsIntroSequenceDone()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_GetIsIntroSequenceDone_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_GetIsTutorialCompleted_Statics
	{
		struct FGTutorialIntroManager_eventGetIsTutorialCompleted_Parms
		{
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_AFGTutorialIntroManager_GetIsTutorialCompleted_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_GetIsTutorialCompleted_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetIsTutorialCompleted()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_GetIsTutorialCompleted_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_GetNormalizedProgressToSkip_Statics
	{
		struct FGTutorialIntroManager_eventGetNormalizedProgressToSkip_Parms
		{
			float ReturnValue;
		};
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_GetNormalizedProgressToSkip_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetNormalizedProgressToSkip()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_GetNormalizedProgressToSkip_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_GetTradingPostLevel_Statics
	{
		struct FGTutorialIntroManager_eventGetTradingPostLevel_Parms
		{
			int32 ReturnValue;
		};
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_GetTradingPostLevel_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_GetTradingPostLevel()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_GetTradingPostLevel_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_HasTradingpostBeenBuilt_Statics
	{
		struct FGTutorialIntroManager_eventHasTradingpostBeenBuilt_Parms
		{
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_AFGTutorialIntroManager_HasTradingpostBeenBuilt_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_HasTradingpostBeenBuilt_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_HasTradingpostBeenBuilt()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_HasTradingpostBeenBuilt_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_IntroDone_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_IntroDone_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_IntroDone()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_IntroDone_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_OnBuildingBuiltGlobal_Statics
	{
		struct FGTutorialIntroManager_eventOnBuildingBuiltGlobal_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_OnBuildingBuiltGlobal_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_OnBuildingBuiltGlobal()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_OnBuildingBuiltGlobal_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_OnPlayerAddedItemToArmSlot_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_OnPlayerAddedItemToArmSlot()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_OnPlayerAddedItemToArmSlot_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_OnPlayerAddedItemToInventory_Statics
	{
		struct FGTutorialIntroManager_eventOnPlayerAddedItemToInventory_Parms
		{
			TSubclassOf<UFGItemDescriptor>  itemClass;
			int32 numAdded;
		};
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_OnPlayerAddedItemToInventory_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_OnPlayerAddedItemToInventory()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_OnPlayerAddedItemToInventory_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_OnRep_TradingPostLevel_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_OnRep_TradingPostLevel_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_OnRep_TradingPostLevel()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_OnRep_TradingPostLevel_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_OnSchematicPurchased_Statics
	{
		struct FGTutorialIntroManager_eventOnSchematicPurchased_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_OnSchematicPurchased_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_OnSchematicPurchased()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_OnSchematicPurchased_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_SetCanSkipTutorialIntro_Statics
	{
		struct FGTutorialIntroManager_eventSetCanSkipTutorialIntro_Parms
		{
			bool canSkip;
		};
		static void NewProp_canSkip_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_canSkip;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	void Z_Construct_UFunction_AFGTutorialIntroManager_SetCanSkipTutorialIntro_Statics::NewProp_canSkip_SetBit(void* Obj)
	{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_SetCanSkipTutorialIntro_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_SetCanSkipTutorialIntro()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_SetCanSkipTutorialIntro_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_SetInputGatesFromTutorialLevel_Statics
	{
		struct FGTutorialIntroManager_eventSetInputGatesFromTutorialLevel_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_SetInputGatesFromTutorialLevel_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_SetInputGatesFromTutorialLevel()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_SetInputGatesFromTutorialLevel_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_StartSkipIntroSequence_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_StartSkipIntroSequence_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_StartSkipIntroSequence()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_StartSkipIntroSequence_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFGTutorialIntroManager_UpdateTutorial_Statics
	{
		struct FGTutorialIntroManager_eventUpdateTutorial_Parms
		{
			EIntroTutorialSteps nextTutorialStep;
		};
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_nextTutorialStep;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_nextTutorialStep_Underlying;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGTutorialIntroManager_UpdateTutorial_Statics::Function_MetaDataParams[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	UFunction* Z_Construct_UFunction_AFGTutorialIntroManager_UpdateTutorial()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGTutorialIntroManager_UpdateTutorial_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	UClass* Z_Construct_UClass_AFGTutorialIntroManager_NoRegister()
	{
		return AFGTutorialIntroManager::StaticClass();
	}
	struct Z_Construct_UClass_AFGTutorialIntroManager_Statics
	{
		...
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_mRecipesToGivePlayersSkippingTutorial_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mHoldToSkipTimerHandle_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_mHoldToSkipTimerHandle;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mHoldTimeToSkipIntro_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_mHoldTimeToSkipIntro;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mWaitTimeAfterCompletingHubStep_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_mWaitTimeAfterCompletingHubStep;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mWaitTimeAfterCompletingMinorStep_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_mWaitTimeAfterCompletingMinorStep;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mTradingPostLevel_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_mTradingPostLevel;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mStartingPod_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_mStartingPod;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mStartingPodClass_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mStartingPodClass;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDidStep5Upgrade_MetaData[];
#endif
		static void NewProp_mDidStep5Upgrade_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mDidStep5Upgrade;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mStep5UpgradeSchematic_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mStep5UpgradeSchematic;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDidStep4Upgrade_MetaData[];
#endif
		static void NewProp_mDidStep4Upgrade_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mDidStep4Upgrade;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mStep4UpgradeSchematic_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mStep4UpgradeSchematic;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDidStep3Upgrade_MetaData[];
#endif
		static void NewProp_mDidStep3Upgrade_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mDidStep3Upgrade;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mStep3UpgradeSchematic_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mStep3UpgradeSchematic;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDidStep2Upgrade_MetaData[];
#endif
		static void NewProp_mDidStep2Upgrade_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mDidStep2Upgrade;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mStep2UpgradeSchematic_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mStep2UpgradeSchematic;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDidStep1_5Upgrade_MetaData[];
#endif
		static void NewProp_mDidStep1_5Upgrade_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mDidStep1_5Upgrade;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mStep1_5UpgradeSchematic_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mStep1_5UpgradeSchematic;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDidStep1Upgrade_MetaData[];
#endif
		static void NewProp_mDidStep1Upgrade_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mDidStep1Upgrade;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mStep1UpgradeSchematic_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mStep1UpgradeSchematic;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDidEquipStunSpear_MetaData[];
#endif
		static void NewProp_mDidEquipStunSpear_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mDidEquipStunSpear;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mStunSpearItemClass_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mStunSpearItemClass;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDidDismantleDropPod_MetaData[];
#endif
		static void NewProp_mDidDismantleDropPod_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mDidDismantleDropPod;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDropPodItemClass_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mDropPodItemClass;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mDidPickUpIronOre_MetaData[];
#endif
		static void NewProp_mDidPickUpIronOre_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mDidPickUpIronOre;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mIronOreDescriptor_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mIronOreDescriptor;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mIntroTutorialData_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_mIntroTutorialData;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_mIntroTutorialData_Inner;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mTradingPostDescriptor_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_mTradingPostDescriptor;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mHasCompletedIntroSequence_MetaData[];
#endif
		static void NewProp_mHasCompletedIntroSequence_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mHasCompletedIntroSequence;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mHasCompletedIntroTutorial_MetaData[];
#endif
		static void NewProp_mHasCompletedIntroTutorial_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mHasCompletedIntroTutorial;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mPendingTutorial_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_mPendingTutorial;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_mPendingTutorial_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mTradingPostBuilt_MetaData[];
#endif
		static void NewProp_mTradingPostBuilt_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_mTradingPostBuilt;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_mOnIntroSequenceStateUpdated_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_mOnIntroSequenceStateUpdated;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const UE4CodeGen_Private::FImplementedInterfaceParams InterfaceParams[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UE4CodeGen_Private::FClassParams ClassParams;
	};
	UObject* (*const Z_Construct_UClass_AFGTutorialIntroManager_Statics::DependentSingletons[])() = {
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFGTutorialIntroManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_CancelSkipIntroSequence, "CancelSkipIntroSequence" }, // 909623230
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_CompleteTutorial, "CompleteTutorial" }, // 4115455840
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_EndSkipIntroSequence, "EndSkipIntroSequence" }, // 2273092982
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_Get, "Get" }, // 3559303940
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_GetCanSkipTutorial, "GetCanSkipTutorial" }, // 3376901909
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_GetCurrentTutorialStep, "GetCurrentTutorialStep" }, // 2367160759
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_GetIsIntroSequenceDone, "GetIsIntroSequenceDone" }, // 2624087316
		...
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_OnSchematicPurchased, "OnSchematicPurchased" }, // 2862241897
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_SetCanSkipTutorialIntro, "SetCanSkipTutorialIntro" }, // 3536716195
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_SetInputGatesFromTutorialLevel, "SetInputGatesFromTutorialLevel" }, // 302873437
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_StartSkipIntroSequence, "StartSkipIntroSequence" }, // 3643694152
		{ &Z_Construct_UFunction_AFGTutorialIntroManager_UpdateTutorial, "UpdateTutorial" }, // 2582719461
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "FGTutorialIntroManager.h" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mRecipesToGivePlayersSkippingTutorial_MetaData[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "List of recipes that player should get the items of if the player chooses to skip the tutorial" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mRecipesToGivePlayersSkippingTutorial = { "mRecipesToGivePlayersSkippingTutorial", nullptr, (EPropertyFlags)0x0040000000010001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFGTutorialIntroManager, mRecipesToGivePlayersSkippingTutorial), METADATA_PARAMS(Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mRecipesToGivePlayersSkippingTutorial_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mRecipesToGivePlayersSkippingTutorial_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mRecipesToGivePlayersSkippingTutorial_Inner = { "mRecipesToGivePlayersSkippingTutorial", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FRecipeAmountPair, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHoldToSkipTimerHandle_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep5Upgrade_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Bool for the step5 schematic" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep5Upgrade_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep4Upgrade_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Bool for the step 4 schematic" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep4Upgrade_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep3Upgrade_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Bool for the step 3 schematic" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep3Upgrade_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep2Upgrade_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Bool for the step 2 schematic" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep2Upgrade_SetBit(void* Obj)
	{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep1_5Upgrade_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Bool for the step 1.5 schematic" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep1_5Upgrade_SetBit(void* Obj)
	{
		((AFGTutorialIntroManager*)Obj)->mDidStep1_5Upgrade = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep1_5Upgrade = { "mDidStep1_5Upgrade", nullptr, (EPropertyFlags)0x0040000001000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AFGTutorialIntroManager), &Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep1_5Upgrade_SetBit, METADATA_PARAMS(Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep1_5Upgrade_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep1_5Upgrade_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStep1_5UpgradeSchematic_MetaData[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Reference to the class step 1.5 tutorial schematic" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStep1_5UpgradeSchematic = { "mStep1_5UpgradeSchematic", nullptr, (EPropertyFlags)0x0044000000010001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFGTutorialIntroManager, mStep1_5UpgradeSchematic), Z_Construct_UClass_UFGSchematic_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStep1_5UpgradeSchematic_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStep1_5UpgradeSchematic_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep1Upgrade_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Bool for the step 1 schematic" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep1Upgrade_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidEquipStunSpear_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Checks if we equipped the stun spear" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidEquipStunSpear_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidDismantleDropPod_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Checks if we have dismantled the drop pod" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidDismantleDropPod_SetBit(void* Obj)
	{
...
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidPickUpIronOre_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHasCompletedIntroSequence_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Indicates that the introduction sequence is done (right now, drop pod sequence)" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHasCompletedIntroSequence_SetBit(void* Obj)
	{
		((AFGTutorialIntroManager*)Obj)->mHasCompletedIntroSequence = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHasCompletedIntroSequence = { "mHasCompletedIntroSequence", nullptr, (EPropertyFlags)0x0040000001000020, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AFGTutorialIntroManager), &Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHasCompletedIntroSequence_SetBit, METADATA_PARAMS(Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHasCompletedIntroSequence_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHasCompletedIntroSequence_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHasCompletedIntroTutorial_MetaData[] = {
		{ "Category", "Tutorial" },
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Indicates if the player has completed the introduction tutorial" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHasCompletedIntroTutorial_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mTradingPostBuilt_MetaData[] = {
		{ "ModuleRelativePath", "Public/FGTutorialIntroManager.h" },
		{ "ToolTip", "Has a trading post been built" },
	};
#endif
	void Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mTradingPostBuilt_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFGTutorialIntroManager_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mWaitTimeAfterCompletingHubStep,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mWaitTimeAfterCompletingMinorStep,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mTradingPostLevel,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStartingPod,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStartingPodClass,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep5Upgrade,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStep5UpgradeSchematic,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep4Upgrade,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStep4UpgradeSchematic,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep3Upgrade,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStep3UpgradeSchematic,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep2Upgrade,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStep2UpgradeSchematic,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep1_5Upgrade,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStep1_5UpgradeSchematic,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidStep1Upgrade,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStep1UpgradeSchematic,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidEquipStunSpear,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mStunSpearItemClass,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidDismantleDropPod,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDropPodItemClass,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mDidPickUpIronOre,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mIronOreDescriptor,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mIntroTutorialData,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mIntroTutorialData_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mTradingPost,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mTradingPostDescriptor,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHasCompletedIntroSequence,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mHasCompletedIntroTutorial,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mPendingTutorial,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mPendingTutorial_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mTradingPostBuilt,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFGTutorialIntroManager_Statics::NewProp_mOnIntroSequenceStateUpdated,
	};
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AFGTutorialIntroManager_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UFGSaveInterface_NoRegister, (int32)VTABLE_OFFSET(AFGTutorialIntroManager, IFGSaveInterface), false },
		};
	const FCppClassTypeInfoStatic Z_Construct_UClass_AFGTutorialIntroManager_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<AFGTutorialIntroManager>::IsAbstract,
	};
	...
	UClass* Z_Construct_UClass_AFGTutorialIntroManager()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AFGTutorialIntroManager_Statics::ClassParams);
		}
		return OuterClass;
	}
